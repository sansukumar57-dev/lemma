export type LemmaActivityAppearance = "default" | "borderless" | "minimal" | "contained"
export type LemmaActivityDensity = "compact" | "comfortable" | "spacious"
export type LemmaActivityRadius = "none" | "sm" | "md" | "lg" | "xl" | "2xl" | "3xl" | "full"

const RADIUS_MAP: Record<LemmaActivityRadius, Record<string, string>> = {
...
export function activityRadiusClassName(
