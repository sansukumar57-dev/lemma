...
class ModifyMessageRequest:
    """ 
        Attributes:
            add_label_ids (list[str] | Unset): A list of IDs of labels to add to this message. You can add up to 100 labels
                with each update.
            remove_label_ids (list[str] | Unset): A list IDs of labels to remove from this message. You can remove up to 100
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        modify_message_request.additional_properties = d
