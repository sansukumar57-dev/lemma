...
T = TypeVar("T", bound="HistoryLabelAdded")
...
class HistoryLabelAdded:
    """ 
        Attributes:
            label_ids (list[str] | Unset): Label IDs added to the message.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        history_label_added = cls(
            label_ids=label_ids,
            message=message,
        )


        history_label_added.additional_properties = d
        return history_label_added
