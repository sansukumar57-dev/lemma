...
T = TypeVar("T", bound="BatchModifyMessagesRequest")
...
class BatchModifyMessagesRequest:
    """ 
        Attributes:
            add_label_ids (list[str] | Unset): A list of label IDs to add to messages.
            ids (list[str] | Unset): The IDs of the messages to modify. There is a limit of 1000 ids per request.
            remove_label_ids (list[str] | Unset): A list of label IDs to remove from messages.
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        batch_modify_messages_request = cls(
        ...
        batch_modify_messages_request.additional_properties = d
        return batch_modify_messages_request
