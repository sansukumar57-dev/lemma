...
from ...models.gmail_users_threads_trash_alt import GmailUsersThreadsTrashAlt
from ...models.gmail_users_threads_trash_xgafv import GmailUsersThreadsTrashXgafv
...
def _get_kwargs(
    ...
    id: str,
    *,
    xgafv: GmailUsersThreadsTrashXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersThreadsTrashAlt | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/gmail/v1/users/{user_id}/threads/{id}/trash".format(user_id=quote(str(user_id), safe=""),id=quote(str(id), safe=""),),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (str):
        id (str):
        xgafv (GmailUsersThreadsTrashXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersThreadsTrashAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
