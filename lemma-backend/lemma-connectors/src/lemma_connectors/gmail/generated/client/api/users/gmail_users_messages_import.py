...
from ...models.gmail_users_messages_import_alt import GmailUsersMessagesImportAlt
from ...models.gmail_users_messages_import_internal_date_source import GmailUsersMessagesImportInternalDateSource
from ...models.gmail_users_messages_import_xgafv import GmailUsersMessagesImportXgafv
...
def _get_kwargs(
    user_id: str,
    *,
    body:    Message  |     Message  |     Message  |     Message  |     Message  |     Message  |     Message  |     Message  |     Message  |     Message  |     Message  |     Message  |     Message  |     Message  |     Message  |     Message  |     Message  |     Message  |     Message  |     Message  |     Message  | Unset = UNSET,
    deleted: bool | Unset = UNSET,
    internal_date_source: GmailUsersMessagesImportInternalDateSource | Unset = UNSET,
    never_mark_spam: bool | Unset = UNSET,
    process_for_calendar: bool | Unset = UNSET,
    xgafv: GmailUsersMessagesImportXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersMessagesImportAlt | Unset = UNSET,
    ...
    json_internal_date_source: str | Unset = UNSET
    if not isinstance(internal_date_source, Unset):
        json_internal_date_source = internal_date_source.value

    params["internalDateSource"] = json_internal_date_source
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/gmail/v1/users/{user_id}/messages/import".format(user_id=quote(str(user_id), safe=""),),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    does not send a message. Note: This function doesn't trigger forwarding rules or filters set up by
    the user.

    Args:
        user_id (str):
        deleted (bool | Unset):
        internal_date_source (GmailUsersMessagesImportInternalDateSource | Unset):
        never_mark_spam (bool | Unset):
        process_for_calendar (bool | Unset):
        xgafv (GmailUsersMessagesImportXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersMessagesImportAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
        ...
        body (Message | Unset): An email message.
        body (Message | Unset): An email message.
        body (Message | Unset): An email message.
        body (Message | Unset): An email message.
        body (Message | Unset): An email message.
...
never_mark_spam=never_mark_spam,
process_for_calendar=process_for_calendar,
xgafv=xgafv,
