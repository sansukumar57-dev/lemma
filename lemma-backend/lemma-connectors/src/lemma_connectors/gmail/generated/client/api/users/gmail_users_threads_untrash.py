...
from ...models.gmail_users_threads_untrash_alt import GmailUsersThreadsUntrashAlt
from ...models.gmail_users_threads_untrash_xgafv import GmailUsersThreadsUntrashXgafv
...
def _get_kwargs(
    ...
    id: str,
    *,
    xgafv: GmailUsersThreadsUntrashXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersThreadsUntrashAlt | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/gmail/v1/users/{user_id}/threads/{id}/untrash".format(user_id=quote(str(user_id), safe=""),id=quote(str(id), safe=""),),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (str):
        id (str):
        xgafv (GmailUsersThreadsUntrashXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersThreadsUntrashAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
