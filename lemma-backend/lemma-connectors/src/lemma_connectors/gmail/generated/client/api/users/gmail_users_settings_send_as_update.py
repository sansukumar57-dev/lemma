...
from ...models.gmail_users_settings_send_as_update_alt import GmailUsersSettingsSendAsUpdateAlt
from ...models.gmail_users_settings_send_as_update_xgafv import GmailUsersSettingsSendAsUpdateXgafv
...
def _get_kwargs(
    ...
    *,
    ...
    xgafv: GmailUsersSettingsSendAsUpdateXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersSettingsSendAsUpdateAlt | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (str):
        send_as_email (str):
        xgafv (GmailUsersSettingsSendAsUpdateXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersSettingsSendAsUpdateAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
