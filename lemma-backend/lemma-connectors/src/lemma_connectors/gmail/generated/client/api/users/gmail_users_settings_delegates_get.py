...
from ...models.gmail_users_settings_delegates_get_alt import GmailUsersSettingsDelegatesGetAlt
from ...models.gmail_users_settings_delegates_get_xgafv import GmailUsersSettingsDelegatesGetXgafv
...
def _get_kwargs(
    ...
    delegate_email: str,
    *,
    xgafv: GmailUsersSettingsDelegatesGetXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersSettingsDelegatesGetAlt | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (str):
        delegate_email (str):
        xgafv (GmailUsersSettingsDelegatesGetXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersSettingsDelegatesGetAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
