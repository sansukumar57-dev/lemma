...
from ...models.gmail_users_settings_forwarding_addresses_create_alt import GmailUsersSettingsForwardingAddressesCreateAlt
from ...models.gmail_users_settings_forwarding_addresses_create_xgafv import GmailUsersSettingsForwardingAddressesCreateXgafv
...
def _get_kwargs(
    user_id: str,
    *,
    body: ForwardingAddress | Unset = UNSET,
    xgafv: GmailUsersSettingsForwardingAddressesCreateXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersSettingsForwardingAddressesCreateAlt | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/gmail/v1/users/{user_id}/settings/forwardingAddresses".format(user_id=quote(str(user_id), safe=""),),
        "params": params,
    }
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ForwardingAddress | None:
    if response.status_code == 200:
        response_200 = ForwardingAddress.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[ForwardingAddress]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (str):
        xgafv (GmailUsersSettingsForwardingAddressesCreateXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersSettingsForwardingAddressesCreateAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
        ...
        body (ForwardingAddress | Unset): Settings for a forwarding address.
