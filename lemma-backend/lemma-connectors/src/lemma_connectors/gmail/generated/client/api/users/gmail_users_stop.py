...
from ...models.gmail_users_stop_alt import GmailUsersStopAlt
from ...models.gmail_users_stop_xgafv import GmailUsersStopXgafv
...
def _get_kwargs(
    user_id: str,
    *,
    xgafv: GmailUsersStopXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersStopAlt | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/gmail/v1/users/{user_id}/stop".format(user_id=quote(str(user_id), safe=""),),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (str):
        xgafv (GmailUsersStopXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersStopAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
