...
from ...models.gmail_users_labels_get_alt import GmailUsersLabelsGetAlt
from ...models.gmail_users_labels_get_xgafv import GmailUsersLabelsGetXgafv
...
def _get_kwargs(
    ...
    id: str,
    *,
    xgafv: GmailUsersLabelsGetXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersLabelsGetAlt | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (str):
        id (str):
        xgafv (GmailUsersLabelsGetXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersLabelsGetAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
