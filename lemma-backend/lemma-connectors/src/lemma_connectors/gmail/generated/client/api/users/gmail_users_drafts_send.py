...
from ...models.gmail_users_drafts_send_alt import GmailUsersDraftsSendAlt
from ...models.gmail_users_drafts_send_xgafv import GmailUsersDraftsSendXgafv
...
def _get_kwargs(
    ...
    *,
    ...
    xgafv: GmailUsersDraftsSendXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersDraftsSendAlt | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/gmail/v1/users/{user_id}/drafts/send".format(user_id=quote(str(user_id), safe=""),),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (str):
        xgafv (GmailUsersDraftsSendXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersDraftsSendAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
