...
from ...models.gmail_users_messages_modify_alt import GmailUsersMessagesModifyAlt
from ...models.gmail_users_messages_modify_xgafv import GmailUsersMessagesModifyXgafv
...
def _get_kwargs(
    ...
    id: str,
    *,
    body: ModifyMessageRequest | Unset = UNSET,
    xgafv: GmailUsersMessagesModifyXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersMessagesModifyAlt | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/gmail/v1/users/{user_id}/messages/{id}/modify".format(user_id=quote(str(user_id), safe=""),id=quote(str(id), safe=""),),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (str):
        id (str):
        xgafv (GmailUsersMessagesModifyXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersMessagesModifyAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
        ...
        body (ModifyMessageRequest | Unset):
