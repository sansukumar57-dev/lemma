...
from ...models.gmail_users_settings_update_vacation_alt import GmailUsersSettingsUpdateVacationAlt
from ...models.gmail_users_settings_update_vacation_xgafv import GmailUsersSettingsUpdateVacationXgafv
...
def _get_kwargs(
    user_id: str,
    *,
    body: VacationSettings | Unset = UNSET,
    xgafv: GmailUsersSettingsUpdateVacationXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersSettingsUpdateVacationAlt | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (str):
        xgafv (GmailUsersSettingsUpdateVacationXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersSettingsUpdateVacationAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
        ...
        body (VacationSettings | Unset): Vacation auto-reply settings for an account. These
            settings correspond to the "Vacation responder" feature in the web interface.
