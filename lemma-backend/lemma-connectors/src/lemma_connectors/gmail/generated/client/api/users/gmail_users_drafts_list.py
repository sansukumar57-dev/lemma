...
from ...models.gmail_users_drafts_list_alt import GmailUsersDraftsListAlt
from ...models.gmail_users_drafts_list_xgafv import GmailUsersDraftsListXgafv
...
def _get_kwargs(
    ...
    *,
    ...
    q: str | Unset = UNSET,
    xgafv: GmailUsersDraftsListXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersDraftsListAlt | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/gmail/v1/users/{user_id}/drafts".format(user_id=quote(str(user_id), safe=""),),
        "params": params,
    }
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ListDraftsResponse | None:
    if response.status_code == 200:
        response_200 = ListDraftsResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[ListDraftsResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        q (str | Unset):
        xgafv (GmailUsersDraftsListXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersDraftsListAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
