...
from ...models.gmail_users_settings_filters_delete_alt import GmailUsersSettingsFiltersDeleteAlt
from ...models.gmail_users_settings_filters_delete_xgafv import GmailUsersSettingsFiltersDeleteXgafv
...
def _get_kwargs(
    ...
    id: str,
    *,
    xgafv: GmailUsersSettingsFiltersDeleteXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersSettingsFiltersDeleteAlt | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (str):
        id (str):
        xgafv (GmailUsersSettingsFiltersDeleteXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersSettingsFiltersDeleteAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
