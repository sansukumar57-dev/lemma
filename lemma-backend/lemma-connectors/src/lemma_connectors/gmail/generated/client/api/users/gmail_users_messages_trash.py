...
from ...models.gmail_users_messages_trash_alt import GmailUsersMessagesTrashAlt
from ...models.gmail_users_messages_trash_xgafv import GmailUsersMessagesTrashXgafv
...
def _get_kwargs(
    ...
    id: str,
    *,
    xgafv: GmailUsersMessagesTrashXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersMessagesTrashAlt | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/gmail/v1/users/{user_id}/messages/{id}/trash".format(user_id=quote(str(user_id), safe=""),id=quote(str(id), safe=""),),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (str):
        id (str):
        xgafv (GmailUsersMessagesTrashXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersMessagesTrashAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
