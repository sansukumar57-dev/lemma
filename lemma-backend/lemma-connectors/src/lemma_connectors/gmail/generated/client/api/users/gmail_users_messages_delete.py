...
from ...models.gmail_users_messages_delete_alt import GmailUsersMessagesDeleteAlt
from ...models.gmail_users_messages_delete_xgafv import GmailUsersMessagesDeleteXgafv
...
def _get_kwargs(
    ...
    id: str,
    *,
    xgafv: GmailUsersMessagesDeleteXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersMessagesDeleteAlt | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (str):
        id (str):
        xgafv (GmailUsersMessagesDeleteXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersMessagesDeleteAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
