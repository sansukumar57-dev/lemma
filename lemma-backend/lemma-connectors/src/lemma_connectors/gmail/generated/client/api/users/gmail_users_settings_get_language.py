...
from ...models.gmail_users_settings_get_language_alt import GmailUsersSettingsGetLanguageAlt
from ...models.gmail_users_settings_get_language_xgafv import GmailUsersSettingsGetLanguageXgafv
...
def _get_kwargs(
    user_id: str,
    *,
    xgafv: GmailUsersSettingsGetLanguageXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersSettingsGetLanguageAlt | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (str):
        xgafv (GmailUsersSettingsGetLanguageXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersSettingsGetLanguageAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
