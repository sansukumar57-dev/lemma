...
from ...models.gmail_users_threads_delete_alt import GmailUsersThreadsDeleteAlt
from ...models.gmail_users_threads_delete_xgafv import GmailUsersThreadsDeleteXgafv
...
def _get_kwargs(
    ...
    id: str,
    *,
    xgafv: GmailUsersThreadsDeleteXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersThreadsDeleteAlt | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (str):
        id (str):
        xgafv (GmailUsersThreadsDeleteXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersThreadsDeleteAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
