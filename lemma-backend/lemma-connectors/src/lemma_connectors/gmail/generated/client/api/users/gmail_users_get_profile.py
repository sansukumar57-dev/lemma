...
from ...models.gmail_users_get_profile_alt import GmailUsersGetProfileAlt
from ...models.gmail_users_get_profile_xgafv import GmailUsersGetProfileXgafv
...
def _get_kwargs(
    user_id: str,
    *,
    xgafv: GmailUsersGetProfileXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersGetProfileAlt | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/gmail/v1/users/{user_id}/profile".format(user_id=quote(str(user_id), safe=""),),
        "params": params,
    }
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Profile | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[Profile]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (str):
        xgafv (GmailUsersGetProfileXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersGetProfileAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
