...
from ...models.gmail_users_settings_cse_identities_get_alt import GmailUsersSettingsCseIdentitiesGetAlt
from ...models.gmail_users_settings_cse_identities_get_xgafv import GmailUsersSettingsCseIdentitiesGetXgafv
...
def _get_kwargs(
    ...
    *,
    xgafv: GmailUsersSettingsCseIdentitiesGetXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersSettingsCseIdentitiesGetAlt | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (str):
        cse_email_address (str):
        xgafv (GmailUsersSettingsCseIdentitiesGetXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersSettingsCseIdentitiesGetAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
