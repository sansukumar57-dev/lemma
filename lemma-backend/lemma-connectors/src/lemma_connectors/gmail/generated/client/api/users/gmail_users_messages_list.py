...
from ...models.gmail_users_messages_list_alt import GmailUsersMessagesListAlt
from ...models.gmail_users_messages_list_xgafv import GmailUsersMessagesListXgafv
...
def _get_kwargs(
    ...
    *,
    ...
    q: str | Unset = UNSET,
    xgafv: GmailUsersMessagesListXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersMessagesListAlt | Unset = UNSET,
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ListMessagesResponse | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[ListMessagesResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        q (str | Unset):
        xgafv (GmailUsersMessagesListXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersMessagesListAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
