...
from ...models.gmail_users_settings_delegates_delete_alt import GmailUsersSettingsDelegatesDeleteAlt
from ...models.gmail_users_settings_delegates_delete_xgafv import GmailUsersSettingsDelegatesDeleteXgafv
...
def _get_kwargs(
    ...
    delegate_email: str,
    *,
    xgafv: GmailUsersSettingsDelegatesDeleteXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersSettingsDelegatesDeleteAlt | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/gmail/v1/users/{user_id}/settings/delegates/{delegate_email}".format(user_id=quote(str(user_id), safe=""),delegate_email=quote(str(delegate_email), safe=""),),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (str):
        delegate_email (str):
        xgafv (GmailUsersSettingsDelegatesDeleteXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersSettingsDelegatesDeleteAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
