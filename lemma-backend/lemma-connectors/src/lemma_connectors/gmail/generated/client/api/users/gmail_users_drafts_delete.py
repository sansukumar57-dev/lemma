...
from ...models.gmail_users_drafts_delete_alt import GmailUsersDraftsDeleteAlt
from ...models.gmail_users_drafts_delete_xgafv import GmailUsersDraftsDeleteXgafv
...
def _get_kwargs(
    ...
    id: str,
    *,
    xgafv: GmailUsersDraftsDeleteXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersDraftsDeleteAlt | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (str):
        id (str):
        xgafv (GmailUsersDraftsDeleteXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersDraftsDeleteAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
