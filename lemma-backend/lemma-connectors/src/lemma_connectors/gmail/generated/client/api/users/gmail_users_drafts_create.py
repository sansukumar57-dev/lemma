...
from ...models.gmail_users_drafts_create_alt import GmailUsersDraftsCreateAlt
from ...models.gmail_users_drafts_create_xgafv import GmailUsersDraftsCreateXgafv
...
def _get_kwargs(
    ...
    *,
    ...
    xgafv: GmailUsersDraftsCreateXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersDraftsCreateAlt | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (str):
        xgafv (GmailUsersDraftsCreateXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersDraftsCreateAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
