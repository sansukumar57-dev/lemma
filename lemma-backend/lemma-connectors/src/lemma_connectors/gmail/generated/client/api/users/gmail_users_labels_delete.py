...
from ...models.gmail_users_labels_delete_alt import GmailUsersLabelsDeleteAlt
from ...models.gmail_users_labels_delete_xgafv import GmailUsersLabelsDeleteXgafv
...
def _get_kwargs(
    ...
    id: str,
    *,
    xgafv: GmailUsersLabelsDeleteXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersLabelsDeleteAlt | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (str):
        id (str):
        xgafv (GmailUsersLabelsDeleteXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersLabelsDeleteAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
