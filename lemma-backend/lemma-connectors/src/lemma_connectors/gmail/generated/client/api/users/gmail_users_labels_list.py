...
from ...models.gmail_users_labels_list_alt import GmailUsersLabelsListAlt
from ...models.gmail_users_labels_list_xgafv import GmailUsersLabelsListXgafv
...
def _get_kwargs(
    user_id: str,
    *,
    xgafv: GmailUsersLabelsListXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersLabelsListAlt | Unset = UNSET,
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ListLabelsResponse | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[ListLabelsResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (str):
        xgafv (GmailUsersLabelsListXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersLabelsListAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
