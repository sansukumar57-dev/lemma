...
from ...models.gmail_users_settings_send_as_verify_alt import GmailUsersSettingsSendAsVerifyAlt
from ...models.gmail_users_settings_send_as_verify_xgafv import GmailUsersSettingsSendAsVerifyXgafv
...
def _get_kwargs(
    ...
    send_as_email: str,
    *,
    xgafv: GmailUsersSettingsSendAsVerifyXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersSettingsSendAsVerifyAlt | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/gmail/v1/users/{user_id}/settings/sendAs/{send_as_email}/verify".format(user_id=quote(str(user_id), safe=""),send_as_email=quote(str(send_as_email), safe=""),),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    `pending`. This method is only available to service account clients that have been delegated domain-
    wide authority.

    Args:
        user_id (str):
        send_as_email (str):
        xgafv (GmailUsersSettingsSendAsVerifyXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersSettingsSendAsVerifyAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
