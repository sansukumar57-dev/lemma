...
from ...models.gmail_users_messages_untrash_alt import GmailUsersMessagesUntrashAlt
from ...models.gmail_users_messages_untrash_xgafv import GmailUsersMessagesUntrashXgafv
...
def _get_kwargs(
    ...
    id: str,
    *,
    xgafv: GmailUsersMessagesUntrashXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersMessagesUntrashAlt | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/gmail/v1/users/{user_id}/messages/{id}/untrash".format(user_id=quote(str(user_id), safe=""),id=quote(str(id), safe=""),),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (str):
        id (str):
        xgafv (GmailUsersMessagesUntrashXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersMessagesUntrashAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
