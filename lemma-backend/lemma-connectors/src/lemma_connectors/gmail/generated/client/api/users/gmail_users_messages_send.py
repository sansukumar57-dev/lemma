...
from ...models.gmail_users_messages_send_alt import GmailUsersMessagesSendAlt
from ...models.gmail_users_messages_send_xgafv import GmailUsersMessagesSendXgafv
...
def _get_kwargs(
    ...
    *,
    ...
    xgafv: GmailUsersMessagesSendXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersMessagesSendAlt | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/gmail/v1/users/{user_id}/messages/send".format(user_id=quote(str(user_id), safe=""),),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (str):
        xgafv (GmailUsersMessagesSendXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersMessagesSendAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
