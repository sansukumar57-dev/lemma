...
from ...models.gmail_users_settings_delegates_list_alt import GmailUsersSettingsDelegatesListAlt
from ...models.gmail_users_settings_delegates_list_xgafv import GmailUsersSettingsDelegatesListXgafv
...
def _get_kwargs(
    user_id: str,
    *,
    xgafv: GmailUsersSettingsDelegatesListXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersSettingsDelegatesListAlt | Unset = UNSET,
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ListDelegatesResponse | None:
    if response.status_code == 200:
        response_200 = ListDelegatesResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[ListDelegatesResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (str):
        xgafv (GmailUsersSettingsDelegatesListXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersSettingsDelegatesListAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
