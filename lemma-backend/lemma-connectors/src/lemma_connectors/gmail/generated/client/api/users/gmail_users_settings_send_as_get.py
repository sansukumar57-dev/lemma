...
from ...models.gmail_users_settings_send_as_get_alt import GmailUsersSettingsSendAsGetAlt
from ...models.gmail_users_settings_send_as_get_xgafv import GmailUsersSettingsSendAsGetXgafv
...
def _get_kwargs(
    ...
    send_as_email: str,
    *,
    xgafv: GmailUsersSettingsSendAsGetXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersSettingsSendAsGetAlt | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (str):
        send_as_email (str):
        xgafv (GmailUsersSettingsSendAsGetXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersSettingsSendAsGetAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
