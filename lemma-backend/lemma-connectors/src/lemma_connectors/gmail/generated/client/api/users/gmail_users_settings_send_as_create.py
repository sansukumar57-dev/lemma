...
from ...models.gmail_users_settings_send_as_create_alt import GmailUsersSettingsSendAsCreateAlt
from ...models.gmail_users_settings_send_as_create_xgafv import GmailUsersSettingsSendAsCreateXgafv
...
def _get_kwargs(
    user_id: str,
    *,
    body: SendAs | Unset = UNSET,
    xgafv: GmailUsersSettingsSendAsCreateXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: GmailUsersSettingsSendAsCreateAlt | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/gmail/v1/users/{user_id}/settings/sendAs".format(user_id=quote(str(user_id), safe=""),),
        "params": params,
    }
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> SendAs | None:
    if response.status_code == 200:
        response_200 = SendAs.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[SendAs]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    r"""  Creates a custom \"from\" send-as alias. If an SMTP MSA is specified, Gmail will attempt to connect
    ...
    Args:
        user_id (str):
        xgafv (GmailUsersSettingsSendAsCreateXgafv | Unset):
        access_token (str | Unset):
        alt (GmailUsersSettingsSendAsCreateAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
        ...
        body (SendAs | Unset): Settings associated with a send-as alias, which can be either the
            primary login address associated with the account or a custom "from" address. Send-as
