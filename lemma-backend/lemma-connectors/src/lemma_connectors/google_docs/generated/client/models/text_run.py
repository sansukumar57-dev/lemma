...
if TYPE_CHECKING:
  from ..models.text_run_suggested_text_style_changes import TextRunSuggestedTextStyleChanges
...
class TextRun:
    """ A ParagraphElement that represents a run of text that all has the same styling.
        ...
        Attributes:
            content (str | Unset): The text of this run. Any non-text elements in the run are replaced with the Unicode
                character U+E907.
            suggested_deletion_ids (list[str] | Unset): The suggested deletion IDs. If empty, then there are no suggested
                deletions of this content.
            suggested_insertion_ids (list[str] | Unset): The suggested insertion IDs. A TextRun may have multiple insertion
                IDs if it's a nested suggested change. If empty, then this is not a suggested insertion.
            suggested_text_style_changes (TextRunSuggestedTextStyleChanges | Unset): The suggested text style changes to
                this run, keyed by suggestion ID.
    ...
    suggested_text_style_changes: TextRunSuggestedTextStyleChanges | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        suggested_text_style_changes: TextRunSuggestedTextStyleChanges | Unset
        if isinstance(_suggested_text_style_changes,  Unset):
            suggested_text_style_changes = UNSET
        else:
            suggested_text_style_changes = TextRunSuggestedTextStyleChanges.from_dict(_suggested_text_style_changes)
        ...
        text_run.additional_properties = d
        return text_run
