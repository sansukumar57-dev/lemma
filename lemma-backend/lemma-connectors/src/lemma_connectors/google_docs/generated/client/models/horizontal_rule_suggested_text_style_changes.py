...
T = TypeVar("T", bound="HorizontalRuleSuggestedTextStyleChanges")



@_attrs_define
class HorizontalRuleSuggestedTextStyleChanges:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.suggested_text_style import SuggestedTextStyle
        d = dict(src_dict)
        horizontal_rule_suggested_text_style_changes = cls(
        )
        ...
        horizontal_rule_suggested_text_style_changes.additional_properties = additional_properties
        return horizontal_rule_suggested_text_style_changes
