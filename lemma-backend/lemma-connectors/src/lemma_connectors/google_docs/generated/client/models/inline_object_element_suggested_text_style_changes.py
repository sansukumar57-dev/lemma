...
T = TypeVar("T", bound="InlineObjectElementSuggestedTextStyleChanges")



@_attrs_define
class InlineObjectElementSuggestedTextStyleChanges:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.suggested_text_style import SuggestedTextStyle
        d = dict(src_dict)
        inline_object_element_suggested_text_style_changes = cls(
        )
        ...
        inline_object_element_suggested_text_style_changes.additional_properties = additional_properties
        return inline_object_element_suggested_text_style_changes
