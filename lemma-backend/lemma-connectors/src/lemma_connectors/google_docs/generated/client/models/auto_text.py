...
from ..models.auto_text_type import AutoTextType
from ..types import UNSET, Unset
from typing import cast

if TYPE_CHECKING:
  from ..models.auto_text_suggested_text_style_changes import AutoTextSuggestedTextStyleChanges
...
class AutoText:
    ...
    time, like a page number.
        ...
        Attributes:
            ...
            suggested_insertion_ids (list[str] | Unset): The suggested insertion IDs. An AutoText may have multiple
                insertion IDs if it's a nested suggested change. If empty, then this is not a suggested insertion.
            suggested_text_style_changes (AutoTextSuggestedTextStyleChanges | Unset): The suggested text style changes to
                this AutoText, keyed by suggestion ID.
            ...
            type_ (AutoTextType | Unset): The type of this auto text.
     """

    suggested_deletion_ids: list[str] | Unset = UNSET
    suggested_insertion_ids: list[str] | Unset = UNSET
    suggested_text_style_changes: AutoTextSuggestedTextStyleChanges | Unset = UNSET
    text_style: TextStyle | Unset = UNSET
    type_: AutoTextType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        suggested_text_style_changes: AutoTextSuggestedTextStyleChanges | Unset
        if isinstance(_suggested_text_style_changes,  Unset):
            suggested_text_style_changes = UNSET
        else:
            suggested_text_style_changes = AutoTextSuggestedTextStyleChanges.from_dict(_suggested_text_style_changes)
        ...
        type_: AutoTextType | Unset
        if isinstance(_type_,  Unset):
            type_ = UNSET
        else:
            type_ = AutoTextType(_type_)
        ...
        auto_text.additional_properties = d
        return auto_text
