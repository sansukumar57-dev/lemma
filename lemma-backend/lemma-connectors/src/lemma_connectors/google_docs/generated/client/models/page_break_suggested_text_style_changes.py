...
T = TypeVar("T", bound="PageBreakSuggestedTextStyleChanges")



@_attrs_define
class PageBreakSuggestedTextStyleChanges:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.suggested_text_style import SuggestedTextStyle
        d = dict(src_dict)
        page_break_suggested_text_style_changes = cls(
        )
        ...
        page_break_suggested_text_style_changes.additional_properties = additional_properties
        return page_break_suggested_text_style_changes
