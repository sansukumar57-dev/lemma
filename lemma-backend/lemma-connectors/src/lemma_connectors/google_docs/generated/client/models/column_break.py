...
if TYPE_CHECKING:
  from ..models.column_break_suggested_text_style_changes import ColumnBreakSuggestedTextStyleChanges
...
class ColumnBreak:
    ...
    next column.
        ...
        Attributes:
            ...
            suggested_insertion_ids (list[str] | Unset): The suggested insertion IDs. A ColumnBreak may have multiple
                insertion IDs if it's a nested suggested change. If empty, then this is not a suggested insertion.
            suggested_text_style_changes (ColumnBreakSuggestedTextStyleChanges | Unset): The suggested text style changes to
                this ColumnBreak, keyed by suggestion ID.
    ...
    suggested_text_style_changes: ColumnBreakSuggestedTextStyleChanges | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        suggested_text_style_changes: ColumnBreakSuggestedTextStyleChanges | Unset
        if isinstance(_suggested_text_style_changes,  Unset):
            suggested_text_style_changes = UNSET
        else:
            suggested_text_style_changes = ColumnBreakSuggestedTextStyleChanges.from_dict(_suggested_text_style_changes)
        ...
        column_break.additional_properties = d
        return column_break
