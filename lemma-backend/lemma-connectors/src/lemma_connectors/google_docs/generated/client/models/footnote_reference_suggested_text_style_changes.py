...
T = TypeVar("T", bound="FootnoteReferenceSuggestedTextStyleChanges")



@_attrs_define
class FootnoteReferenceSuggestedTextStyleChanges:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.suggested_text_style import SuggestedTextStyle
        d = dict(src_dict)
        footnote_reference_suggested_text_style_changes = cls(
        )
        ...
        footnote_reference_suggested_text_style_changes.additional_properties = additional_properties
        return footnote_reference_suggested_text_style_changes
