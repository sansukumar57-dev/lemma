...
T = TypeVar("T", bound="ColumnBreakSuggestedTextStyleChanges")



@_attrs_define
class ColumnBreakSuggestedTextStyleChanges:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.suggested_text_style import SuggestedTextStyle
        d = dict(src_dict)
        column_break_suggested_text_style_changes = cls(
        )
        ...
        column_break_suggested_text_style_changes.additional_properties = additional_properties
        return column_break_suggested_text_style_changes
