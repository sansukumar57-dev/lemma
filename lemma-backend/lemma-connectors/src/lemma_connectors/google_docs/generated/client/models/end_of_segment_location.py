...
T = TypeVar("T", bound="EndOfSegmentLocation")



@_attrs_define
class EndOfSegmentLocation:
    """ Location at the end of a body, header, footer or footnote. The location is immediately before the last newline in
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        end_of_segment_location = cls(
            segment_id=segment_id,
        )


        end_of_segment_location.additional_properties = d
        return end_of_segment_location
