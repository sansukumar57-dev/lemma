...
T = TypeVar("T", bound="DeleteContentRangeRequest")
...
class DeleteContentRangeRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_content_range_request = cls(
            range_=range_,
        )


        delete_content_range_request.additional_properties = d
        return delete_content_range_request
