...
T = TypeVar("T", bound="PersonSuggestedTextStyleChanges")



@_attrs_define
class PersonSuggestedTextStyleChanges:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.suggested_text_style import SuggestedTextStyle
        d = dict(src_dict)
        person_suggested_text_style_changes = cls(
        )
        ...
        person_suggested_text_style_changes.additional_properties = additional_properties
        return person_suggested_text_style_changes
