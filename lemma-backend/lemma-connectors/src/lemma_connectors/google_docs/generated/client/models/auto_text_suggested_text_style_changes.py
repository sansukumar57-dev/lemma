...
T = TypeVar("T", bound="AutoTextSuggestedTextStyleChanges")



@_attrs_define
class AutoTextSuggestedTextStyleChanges:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.suggested_text_style import SuggestedTextStyle
        d = dict(src_dict)
        auto_text_suggested_text_style_changes = cls(
        )
        ...
        auto_text_suggested_text_style_changes.additional_properties = additional_properties
        return auto_text_suggested_text_style_changes
