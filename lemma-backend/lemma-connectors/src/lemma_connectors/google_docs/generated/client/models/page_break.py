...
if TYPE_CHECKING:
  from ..models.page_break_suggested_text_style_changes import PageBreakSuggestedTextStyleChanges
...
T = TypeVar("T", bound="PageBreak")



@_attrs_define
class PageBreak:
    """ A ParagraphElement representing a page break. A page break makes the subsequent text start at the top of the next
    page.

        Attributes:
            suggested_deletion_ids (list[str] | Unset): The suggested deletion IDs. If empty, then there are no suggested
                deletions of this content.
            suggested_insertion_ids (list[str] | Unset): The suggested insertion IDs. A PageBreak may have multiple
                insertion IDs if it's a nested suggested change. If empty, then this is not a suggested insertion.
            suggested_text_style_changes (PageBreakSuggestedTextStyleChanges | Unset): The suggested text style changes to
                this PageBreak, keyed by suggestion ID.
    ...
    suggested_text_style_changes: PageBreakSuggestedTextStyleChanges | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        suggested_text_style_changes: PageBreakSuggestedTextStyleChanges | Unset
        if isinstance(_suggested_text_style_changes,  Unset):
            suggested_text_style_changes = UNSET
        else:
            suggested_text_style_changes = PageBreakSuggestedTextStyleChanges.from_dict(_suggested_text_style_changes)
        ...
        page_break.additional_properties = d
        return page_break
