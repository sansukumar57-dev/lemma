...
T = TypeVar("T", bound="UnmergeTableCellsRequest")
...
class UnmergeTableCellsRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        unmerge_table_cells_request = cls(
            table_range=table_range,
        )


        unmerge_table_cells_request.additional_properties = d
        return unmerge_table_cells_request
