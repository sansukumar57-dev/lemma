...
T = TypeVar("T", bound="RichLinkSuggestedTextStyleChanges")



@_attrs_define
class RichLinkSuggestedTextStyleChanges:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.suggested_text_style import SuggestedTextStyle
        d = dict(src_dict)
        rich_link_suggested_text_style_changes = cls(
        )
        ...
        rich_link_suggested_text_style_changes.additional_properties = additional_properties
        return rich_link_suggested_text_style_changes
