...
from ...models.docs_documents_create_alt import DocsDocumentsCreateAlt
from ...models.docs_documents_create_xgafv import DocsDocumentsCreateXgafv
...
def _get_kwargs(
    *,
    body: Document | Unset = UNSET,
    xgafv: DocsDocumentsCreateXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: DocsDocumentsCreateAlt | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        xgafv (DocsDocumentsCreateXgafv | Unset):
        access_token (str | Unset):
        alt (DocsDocumentsCreateAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
        ...
        body (Document | Unset): A Google Docs document.
