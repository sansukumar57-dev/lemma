...
if TYPE_CHECKING:
  from ..models.jql_function_precomputation_bean import JqlFunctionPrecomputationBean





T = TypeVar("T", bound="PageBeanJqlFunctionPrecomputationBean")
...
class PageBeanJqlFunctionPrecomputationBean:
    """ A page of items.
        ...
        Attributes:
            ...
            values (list[JqlFunctionPrecomputationBean] | Unset): The list of items.
     """
    ...
    values: list[JqlFunctionPrecomputationBean] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = JqlFunctionPrecomputationBean.from_dict(values_item_data)
        ...
        page_bean_jql_function_precomputation_bean = cls(
            is_last=is_last,
        ...
        return page_bean_jql_function_precomputation_bean
