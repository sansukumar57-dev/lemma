...
class ProjectRole:
    """ Details about the roles in a project.
        ...
        Attributes:
            actors (list[RoleActor] | Unset): The list of users who act in this role.
            admin (bool | Unset): Whether this role is the admin role for the project.
            current_user_role (bool | Unset): Whether the calling user is part of this role.
    ...
    actors: list[RoleActor] | Unset = UNSET
    admin: bool | Unset = UNSET
    current_user_role: bool | Unset = UNSET
