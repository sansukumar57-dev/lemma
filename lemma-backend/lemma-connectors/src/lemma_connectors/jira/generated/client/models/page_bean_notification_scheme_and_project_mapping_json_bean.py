...
if TYPE_CHECKING:
  from ..models.notification_scheme_and_project_mapping_json_bean import NotificationSchemeAndProjectMappingJsonBean





T = TypeVar("T", bound="PageBeanNotificationSchemeAndProjectMappingJsonBean")
...
class PageBeanNotificationSchemeAndProjectMappingJsonBean:
    """ A page of items.
        ...
        Attributes:
            ...
            values (list[NotificationSchemeAndProjectMappingJsonBean] | Unset): The list of items.
     """
    ...
    values: list[NotificationSchemeAndProjectMappingJsonBean] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = NotificationSchemeAndProjectMappingJsonBean.from_dict(values_item_data)
        ...
        page_bean_notification_scheme_and_project_mapping_json_bean = cls(
            is_last=is_last,
        ...
        return page_bean_notification_scheme_and_project_mapping_json_bean
