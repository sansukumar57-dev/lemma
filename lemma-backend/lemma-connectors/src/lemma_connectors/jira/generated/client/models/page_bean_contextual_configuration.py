...
T = TypeVar("T", bound="PageBeanContextualConfiguration")
...
class PageBeanContextualConfiguration:
    """ A page of items.
        ...
        Attributes:
            ...
            values (list[ContextualConfiguration] | Unset): The list of items.
     """
    ...
    values: list[ContextualConfiguration] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = ContextualConfiguration.from_dict(values_item_data)
        ...
        page_bean_contextual_configuration = cls(
            is_last=is_last,
        ...
        return page_bean_contextual_configuration
