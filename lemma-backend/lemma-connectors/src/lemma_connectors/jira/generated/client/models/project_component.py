...
from ..models.project_component_assignee_type import ProjectComponentAssigneeType
from ..models.project_component_real_assignee_type import ProjectComponentRealAssigneeType
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="ProjectComponent")
...
class ProjectComponent:
    """ Details about a project component.
        ...
        Attributes:
            ...
            assignee_type (ProjectComponentAssigneeType | Unset): The nominal user type used to determine the assignee for
                issues created with this component. See `realAssigneeType` for details on how the type of the user, and hence
                the user, assigned to issues is determined. Can take the following values:
            ...
            description (str | Unset): The description for the component. Optional when creating or updating a component.
            ...
            lead (User | Unset): A user with details as permitted by the user's Atlassian Account privacy settings. However,
                 ...
                 *  User record unavailable: This usually occurs due to an internal service outage. In this case, all parameters
                have fallback values.
            lead_account_id (str | Unset): The accountId of the component's lead user. The accountId uniquely identifies the
                user across all Atlassian products. For example, *5b10ac8d82e05b22cc7d4ef5*.
            lead_user_name (str | Unset): This property is no longer available and will be removed from the documentation
                soon. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-
                privacy-api-migration-guide/) for details.
            name (str | Unset): The unique name for the component in the project. Required when creating a component.
                Optional when updating a component. The maximum length is 255 characters.
            project (str | Unset): The key of the project the component is assigned to. Required when creating a component.
                Can't be updated.
            project_id (int | Unset): The ID of the project the component is assigned to.
            real_assignee (User | Unset): A user with details as permitted by the user's Atlassian Account privacy settings.
                 ...
                 *  User record unavailable: This usually occurs due to an internal service outage. In this case, all parameters
                have fallback values.
            real_assignee_type (ProjectComponentRealAssigneeType | Unset): The type of the assignee that is assigned to
                issues created with this component, when an assignee cannot be set from the `assigneeType`. For example,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assignee_type: ProjectComponentAssigneeType | Unset
        if isinstance(_assignee_type,  Unset):
            assignee_type = UNSET
        else:
            assignee_type = ProjectComponentAssigneeType(_assignee_type)
        ...
        real_assignee_type: ProjectComponentRealAssigneeType | Unset
        if isinstance(_real_assignee_type,  Unset):
            real_assignee_type = UNSET
        else:
            real_assignee_type = ProjectComponentRealAssigneeType(_real_assignee_type)
