...
if TYPE_CHECKING:
  from ..models.field_configuration_details import FieldConfigurationDetails





T = TypeVar("T", bound="PageBeanFieldConfigurationDetails")
...
class PageBeanFieldConfigurationDetails:
    """ A page of items.
        ...
        Attributes:
            ...
            values (list[FieldConfigurationDetails] | Unset): The list of items.
     """
    ...
    values: list[FieldConfigurationDetails] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = FieldConfigurationDetails.from_dict(values_item_data)
        ...
        page_bean_field_configuration_details = cls(
            is_last=is_last,
        ...
        return page_bean_field_configuration_details
