...
if TYPE_CHECKING:
  from ..models.resolution_json_bean import ResolutionJsonBean





T = TypeVar("T", bound="PageBeanResolutionJsonBean")
...
class PageBeanResolutionJsonBean:
    """ A page of items.
        ...
        Attributes:
            ...
            values (list[ResolutionJsonBean] | Unset): The list of items.
     """
    ...
    values: list[ResolutionJsonBean] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = ResolutionJsonBean.from_dict(values_item_data)
        ...
        page_bean_resolution_json_bean = cls(
            is_last=is_last,
        ...
        return page_bean_resolution_json_bean
