...
T = TypeVar("T", bound="PageBeanProjectDetails")
...
class PageBeanProjectDetails:
    """ A page of items.
        ...
        Attributes:
            ...
            values (list[ProjectDetails] | Unset): The list of items.
     """
    ...
    values: list[ProjectDetails] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = ProjectDetails.from_dict(values_item_data)
        ...
        return page_bean_project_details
