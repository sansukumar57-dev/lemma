...
if TYPE_CHECKING:
  from ..models.ui_modification_details import UiModificationDetails





T = TypeVar("T", bound="PageBeanUiModificationDetails")
...
class PageBeanUiModificationDetails:
    """ A page of items.
        ...
        Attributes:
            ...
            values (list[UiModificationDetails] | Unset): The list of items.
     """
    ...
    values: list[UiModificationDetails] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = UiModificationDetails.from_dict(values_item_data)
        ...
        page_bean_ui_modification_details = cls(
            is_last=is_last,
        ...
        return page_bean_ui_modification_details
