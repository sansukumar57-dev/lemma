...
T = TypeVar("T", bound="PageBeanPriority")
...
class PageBeanPriority:
    """ A page of items.
        ...
        Attributes:
            ...
            values (list[Priority] | Unset): The list of items.
     """
    ...
    values: list[Priority] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = Priority.from_dict(values_item_data)
