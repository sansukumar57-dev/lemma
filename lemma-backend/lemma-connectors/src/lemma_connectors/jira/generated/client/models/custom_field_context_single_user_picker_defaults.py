...
T = TypeVar("T", bound="CustomFieldContextSingleUserPickerDefaults")
...
class CustomFieldContextSingleUserPickerDefaults:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_field_context_single_user_picker_defaults = cls(
        ...
        custom_field_context_single_user_picker_defaults.additional_properties = d
        return custom_field_context_single_user_picker_defaults
