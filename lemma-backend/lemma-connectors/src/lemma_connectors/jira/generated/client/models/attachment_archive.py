...
class AttachmentArchive:
    """ 
        Attributes:
            entries (list[AttachmentArchiveEntry] | Unset):
            more_available (bool | Unset):
            total_entry_count (int | Unset):
            total_number_of_entries_available (int | Unset):
     """

    entries: list[AttachmentArchiveEntry] | Unset = UNSET
    more_available: bool | Unset = UNSET
    total_entry_count: int | Unset = UNSET
    total_number_of_entries_available: int | Unset = UNSET
