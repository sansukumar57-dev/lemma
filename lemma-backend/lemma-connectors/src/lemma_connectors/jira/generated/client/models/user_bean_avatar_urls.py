...
class UserBeanAvatarUrls:
    """ 
        Attributes:
            field_16x16 (str | Unset): The URL of the user's 16x16 pixel avatar.
            field_24x24 (str | Unset): The URL of the user's 24x24 pixel avatar.
            field_32x32 (str | Unset): The URL of the user's 32x32 pixel avatar.
            field_48x48 (str | Unset): The URL of the user's 48x48 pixel avatar.
     """
