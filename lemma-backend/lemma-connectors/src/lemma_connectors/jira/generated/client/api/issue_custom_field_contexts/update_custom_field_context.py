...
def sync_detailed(
    ...
    *,
    ...
    """ Update custom field context
     ...
     Updates a [ custom field context](https://confluence.atlassian.com/adminjiracloud/what-are-custom-
    ...
    **[Permissions](#permissions) required:** *Administer Jira* [global
    ...
    Args:
        field_id (str):
        context_id (int):
        body (CustomFieldContextUpdateDetails): Details of a custom field context.
