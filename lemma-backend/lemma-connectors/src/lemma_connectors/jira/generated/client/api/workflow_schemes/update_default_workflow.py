...
def sync_detailed(
    ...
    *,
    ...
    `updateDraftIfNeeded` to `true` in the request object and a draft workflow scheme is created or
    updated with the new default workflow. The draft workflow scheme can be published in Jira.
    ...
    **[Permissions](#permissions) required:** *Administer Jira* [global
    ...
    Args:
        id (int):
        body (DefaultWorkflow): Details about the default workflow.
