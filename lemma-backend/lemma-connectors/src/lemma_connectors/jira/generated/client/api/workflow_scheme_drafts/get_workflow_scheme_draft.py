...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/rest/api/3/workflowscheme/{id}/draft".format(id=quote(str(id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ Get draft workflow scheme
     ...
     Returns the draft workflow scheme for an active workflow scheme. Draft workflow schemes allow
    changes to be made to the active workflow schemes: When an active workflow scheme is updated, a
    draft copy is created. The draft is modified, then the changes in the draft are copied back to the
