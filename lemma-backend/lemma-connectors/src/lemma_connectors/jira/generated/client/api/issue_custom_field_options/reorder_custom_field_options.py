...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/rest/api/3/field/{field_id}/context/{context_id}/option/move".format(field_id=quote(str(field_id), safe=""),context_id=quote(str(context_id), safe=""),),
    }
...
def sync_detailed(
    ...
    **[Permissions](#permissions) required:** *Administer Jira* [global
    ...
    Args:
        field_id (str):
        context_id (int):
        body (OrderOfCustomFieldOptions): An ordered list of custom field option IDs and
            information on where to move them.
