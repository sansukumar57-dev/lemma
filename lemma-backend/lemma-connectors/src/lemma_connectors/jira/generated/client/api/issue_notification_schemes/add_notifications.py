...
from ...models.add_notifications_details import AddNotificationsDetails
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/rest/api/3/notificationscheme/{id}/notification".format(id=quote(str(id), safe=""),),
    }
...
def sync_detailed(
    ...
    **[Permissions](#permissions) required:** *Administer Jira* [global
    ...
    Args:
        id (str):
        body (AddNotificationsDetails): Details of notifications which should be added to the
            notification scheme.
