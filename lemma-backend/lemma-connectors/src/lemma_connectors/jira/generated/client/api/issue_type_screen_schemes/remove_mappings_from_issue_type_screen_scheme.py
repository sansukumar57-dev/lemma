...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/rest/api/3/issuetypescreenscheme/{issue_type_screen_scheme_id}/mapping/remove".format(issue_type_screen_scheme_id=quote(str(issue_type_screen_scheme_id), safe=""),),
    }
