...
def _get_kwargs(
    ...
    *,
    ...
    key: str,
    workflow_name: str,
    workflow_mode: UpdateWorkflowTransitionPropertyWorkflowMode | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    """ Update workflow transition property
     ...
     Updates a workflow transition by changing the property value. Trying to update a property that does
    not exist results in a new property being added to the transition. Transition properties are used to
    ...
    **[Permissions](#permissions) required:** *Administer Jira* [global
    ...
    Args:
        ...
        key (str):
        workflow_name (str):
        workflow_mode (UpdateWorkflowTransitionPropertyWorkflowMode | Unset):
