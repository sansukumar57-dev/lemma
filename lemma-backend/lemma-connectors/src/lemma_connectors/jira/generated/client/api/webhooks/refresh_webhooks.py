...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ErrorCollection | WebhooksExpirationDate | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[ErrorCollection | WebhooksExpirationDate]:
    return Response(
...
def sync_detailed(
...
) -> Response[ErrorCollection | WebhooksExpirationDate]:
    """ Extend webhook life

     Extends the life of webhook. Webhooks registered through the REST API expire after 30 days. Call
    ...
    **[Permissions](#permissions) required:** Only
    ...
    Args:
        body (ContainerForWebhookIDs): Container for a list of webhook IDs.
...
def sync(
...
) -> ErrorCollection | WebhooksExpirationDate | None:
    """ Extend webhook life
    ...
    **[Permissions](#permissions) required:** Only
    ...
    Returns:
        ErrorCollection | WebhooksExpirationDate
     """
