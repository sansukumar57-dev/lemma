...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/rest/api/3/issue/{issue_id_or_key}/properties/{property_key}".format(issue_id_or_key=quote(str(issue_id_or_key), safe=""),property_key=quote(str(property_key), safe=""),),
    }
