...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/rest/api/3/issuetype/{id}/avatar2".format(id=quote(str(id), safe=""),),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    For example:
    `curl --request POST \ --user email@example.com:<api_token> \ --header 'X-Atlassian-Token: no-check'
    \ --header 'Content-Type: image/< image_type>' \ --data-binary \"<@/path/to/file/with/your/avatar>\"
    \ --url 'https://your-domain.atlassian.net/rest/api/3/issuetype/{issueTypeId}'This`
    ...
    After creating the avatar, use [ Update issue type](#api-rest-api-3-issuetype-id-put) to set it as
    the issue type's displayed avatar.
