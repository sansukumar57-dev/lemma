...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/rest/api/3/issuetype/{issue_type_id}/properties".format(issue_type_id=quote(str(issue_type_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ Get issue type property keys
     ...
     Returns all the [issue type property](https://developer.atlassian.com/cloud/jira/platform/storing-
    data-without-a-database/#a-id-jira-entity-properties-a-jira-entity-properties) keys of the issue
    type.
    ...
    **[Permissions](#permissions) required:**
    ...
    property keys of any issue types associated with the projects the user has permission to browse.
