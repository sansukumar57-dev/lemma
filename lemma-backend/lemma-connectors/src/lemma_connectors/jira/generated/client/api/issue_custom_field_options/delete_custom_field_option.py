...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/rest/api/3/field/{field_id}/context/{context_id}/option/{option_id}".format(field_id=quote(str(field_id), safe=""),context_id=quote(str(context_id), safe=""),option_id=quote(str(option_id), safe=""),),
    }
