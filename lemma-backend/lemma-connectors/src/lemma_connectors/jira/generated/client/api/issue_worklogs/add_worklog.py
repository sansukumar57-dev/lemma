...
def _get_kwargs(
    ...
    *,
    ...
    adjust_estimate: AddWorklogAdjustEstimate | Unset = AddWorklogAdjustEstimate.AUTO,
    new_estimate: str | Unset = UNSET,
    reduce_by: str | Unset = UNSET,
    expand: str | Unset = '',
...
def sync_detailed(
    ...
    **[Permissions](#permissions) required:**
    ...
    Args:
        ...
        adjust_estimate (AddWorklogAdjustEstimate | Unset):  Default:
            AddWorklogAdjustEstimate.AUTO.
