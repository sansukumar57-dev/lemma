...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/rest/api/3/notificationscheme/{id}".format(id=quote(str(id), safe=""),),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ Get notification scheme
     ...
     Returns a [notification scheme](https://confluence.atlassian.com/x/8YdKLg), including the list of
    events and the recipients who will receive notifications for those events.

    **[Permissions](#permissions) required:** Permission to access Jira, however, the user must have
    permission to administer at least one project associated with the notification scheme.
