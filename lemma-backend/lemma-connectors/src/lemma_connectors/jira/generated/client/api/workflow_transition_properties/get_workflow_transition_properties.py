...
def _get_kwargs(
    transition_id: int,
    *,
    include_reserved_keys: bool | Unset = False,
    key: str | Unset = UNSET,
    workflow_name: str,
    workflow_mode: GetWorkflowTransitionPropertiesWorkflowMode | Unset = GetWorkflowTransitionPropertiesWorkflowMode.LIVE,
    ...
    params["includeReservedKeys"] = include_reserved_keys
...
def sync_detailed(
    ...
    *,
    ...
    """ Get workflow transition properties
     ...
     Returns the properties on a workflow transition. Transition properties are used to change the
    ...
    **[Permissions](#permissions) required:** *Administer Jira* [global
    ...
    Args:
        transition_id (int):
        include_reserved_keys (bool | Unset):  Default: False.
        key (str | Unset):
        workflow_name (str):
        workflow_mode (GetWorkflowTransitionPropertiesWorkflowMode | Unset):  Default:
