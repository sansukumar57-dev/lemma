...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/rest/api/3/workflowscheme/{id}/createdraft".format(id=quote(str(id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ Create draft workflow scheme
     ...
     Create a draft workflow scheme from an active workflow scheme, by copying the active workflow
    scheme. Note that an active workflow scheme can only have one draft workflow scheme.
