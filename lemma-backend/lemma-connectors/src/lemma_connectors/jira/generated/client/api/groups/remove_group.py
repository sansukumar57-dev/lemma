...
def _get_kwargs(
    *,
    ...
    swap_group: str | Unset = UNSET,
    swap_group_id: str | Unset = UNSET,
...
def sync_detailed(
    ...
    **[Permissions](#permissions) required:** Site administration (that is, member of the *site-admin*
    strategic [group](https://confluence.atlassian.com/x/24xjL)).

    Args:
        groupname (str | Unset):
        group_id (str | Unset):
        swap_group (str | Unset):
        swap_group_id (str | Unset):
