...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/rest/api/3/workflowscheme/{id}".format(id=quote(str(id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ Update workflow scheme
     ...
     Updates a workflow scheme, including the name, default workflow, issue type to project mappings, and
    more. If the workflow scheme is active (that is, being used by at least one project), then a draft
