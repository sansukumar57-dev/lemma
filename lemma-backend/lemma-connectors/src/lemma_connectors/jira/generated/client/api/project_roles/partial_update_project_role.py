...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/rest/api/3/role/{id}".format(id=quote(str(id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    You cannot update both the name and description at the same time using this operation. If you send a
    request with a name and a description only the name is updated.
