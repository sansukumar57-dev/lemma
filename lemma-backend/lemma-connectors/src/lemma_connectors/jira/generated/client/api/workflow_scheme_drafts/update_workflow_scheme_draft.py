...
def sync_detailed(
    ...
    *,
    ...
    """ Update draft workflow scheme
     ...
     Updates a draft workflow scheme. If a draft workflow scheme does not exist for the active workflow
    scheme, then a draft is created. Note that an active workflow scheme can only have one draft
    workflow scheme.
    ...
    **[Permissions](#permissions) required:** *Administer Jira* [global
    ...
    Args:
        id (int):
        body (WorkflowScheme): Details about a workflow scheme.
