...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/rest/api/3/workflowscheme/{id}/draft/workflow".format(id=quote(str(id), safe=""),),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ Set issue types for workflow in workflow scheme
     ...
     Sets the issue types for a workflow in a workflow scheme's draft. The workflow can also be set as
    the default workflow for the draft workflow scheme. Unmapped issues types are mapped to the default
    workflow.
