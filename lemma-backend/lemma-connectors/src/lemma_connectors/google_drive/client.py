...
from lemma_connectors.google_drive.resources import build_resources

BASE_URL = "https://www.googleapis.com/drive/v3"
CLIENT_MODULE_PATH = "lemma_connectors.google_drive.generated.client.client"
METADATA_PATH = (
    Path(__file__).resolve().parent / "generated" / "openapi_metadata.json"
)


class GoogleDriveInfoClient(BaseInfoClient):
    def __init__(self):
        super().__init__(
