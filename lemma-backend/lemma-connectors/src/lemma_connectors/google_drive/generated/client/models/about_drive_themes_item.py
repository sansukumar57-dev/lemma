...
T = TypeVar("T", bound="AboutDriveThemesItem")



@_attrs_define
class AboutDriveThemesItem:
    """ 
        Attributes:
            background_image_link (str | Unset): A link to this theme's background image.
            color_rgb (str | Unset): The color of this theme as an RGB hex string.
            id (str | Unset): The ID of the theme.
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        about_drive_themes_item.additional_properties = d
        return about_drive_themes_item
