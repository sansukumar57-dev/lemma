...
T = TypeVar("T", bound="TeamDriveBackgroundImageFile")
...
class TeamDriveBackgroundImageFile:
    ...
    field; it can only be set on drive.teamdrives.update requests that don't set themeId. When specified, all fields of
    the backgroundImageFile must be set.

        Attributes:
            id (str | Unset): The ID of an image file in Drive to use for the background image.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        team_drive_background_image_file = cls(
            id=id,
            width=width,
        ...
        team_drive_background_image_file.additional_properties = d
        return team_drive_background_image_file
