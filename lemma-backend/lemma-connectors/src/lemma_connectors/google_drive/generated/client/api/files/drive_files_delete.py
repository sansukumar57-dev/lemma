...
from ...models.drive_files_delete_alt import DriveFilesDeleteAlt
...
def _get_kwargs(
    ...
    *,
    ...
    alt: DriveFilesDeleteAlt | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    a shared drive the user must be an organizer on the parent. If the target is a folder, all
