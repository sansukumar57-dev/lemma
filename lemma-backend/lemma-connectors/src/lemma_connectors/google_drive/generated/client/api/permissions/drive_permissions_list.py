...
from ...models.drive_permissions_list_alt import DrivePermissionsListAlt
from ...models.permission_list import PermissionList
...
def _get_kwargs(
    ...
    *,
    ...
    alt: DrivePermissionsListAlt | Unset = UNSET,
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> PermissionList | None:
    if response.status_code == 200:
        response_200 = PermissionList.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[PermissionList]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        alt (DrivePermissionsListAlt | Unset):
        fields (str | Unset):
        key (str | Unset):
