...
from ...models.drive_files_export_alt import DriveFilesExportAlt
...
def _get_kwargs(
    ...
    *,
    mime_type: str,
    alt: DriveFilesExportAlt | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/files/{file_id}/export".format(file_id=quote(str(file_id), safe=""),),
        "params": params,
    }
