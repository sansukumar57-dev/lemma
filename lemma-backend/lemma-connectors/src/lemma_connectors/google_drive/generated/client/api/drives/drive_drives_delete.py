...
from ...models.drive_drives_delete_alt import DriveDrivesDeleteAlt
...
def _get_kwargs(
    drive_id: str,
    *,
    allow_item_deletion: bool | Unset = UNSET,
    use_domain_admin_access: bool | Unset = UNSET,
    alt: DriveDrivesDeleteAlt | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        drive_id (str):
        allow_item_deletion (bool | Unset):
        use_domain_admin_access (bool | Unset):
        alt (DriveDrivesDeleteAlt | Unset):
        fields (str | Unset):
        key (str | Unset):
    ...
    kwargs = _get_kwargs(
        drive_id=drive_id,
allow_item_deletion=allow_item_deletion,
