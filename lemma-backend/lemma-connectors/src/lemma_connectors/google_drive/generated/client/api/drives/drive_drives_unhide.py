...
from ...models.drive_drives_unhide_alt import DriveDrivesUnhideAlt
...
def _get_kwargs(
    drive_id: str,
    *,
    alt: DriveDrivesUnhideAlt | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/drives/{drive_id}/unhide".format(drive_id=quote(str(drive_id), safe=""),),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        drive_id (str):
        alt (DriveDrivesUnhideAlt | Unset):
        fields (str | Unset):
        key (str | Unset):
