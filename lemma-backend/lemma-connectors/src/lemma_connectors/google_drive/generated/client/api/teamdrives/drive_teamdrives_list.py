...
from ...models.drive_teamdrives_list_alt import DriveTeamdrivesListAlt
from ...models.team_drive_list import TeamDriveList
...
def _get_kwargs(
    *,
    ...
    alt: DriveTeamdrivesListAlt | Unset = UNSET,
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> TeamDriveList | None:
    if response.status_code == 200:
        response_200 = TeamDriveList.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[TeamDriveList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        alt (DriveTeamdrivesListAlt | Unset):
        fields (str | Unset):
        key (str | Unset):
