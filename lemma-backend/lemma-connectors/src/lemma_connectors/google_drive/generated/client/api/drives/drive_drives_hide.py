...
from ...models.drive_drives_hide_alt import DriveDrivesHideAlt
...
def _get_kwargs(
    drive_id: str,
    *,
    alt: DriveDrivesHideAlt | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/drives/{drive_id}/hide".format(drive_id=quote(str(drive_id), safe=""),),
        "params": params,
    }
