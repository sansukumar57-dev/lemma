...
T = TypeVar("T", bound="AddSheetRequest")
...
class AddSheetRequest:
    ...
    object sheet, use AddChartRequest instead and specify EmbeddedObjectPosition.sheetId or
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        add_sheet_request = cls(
            properties=properties,
        )


        add_sheet_request.additional_properties = d
