...
T = TypeVar("T", bound="AddProtectedRangeResponse")
...
class AddProtectedRangeResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        add_protected_range_response = cls(
            protected_range=protected_range,
        )


        add_protected_range_response.additional_properties = d
        return add_protected_range_response
