...
T = TypeVar("T", bound="DataSourceParameter")



@_attrs_define
class DataSourceParameter:
    """ A parameter in a data source's query. The parameter allows the user to pass in values from the spreadsheet into a
    query.

        Attributes:
            name (str | Unset): Named parameter. Must be a legitimate identifier for the DataSource that supports it. For
                example, [BigQuery identifier](https://cloud.google.com/bigquery/docs/reference/standard-
                sql/lexical#identifiers).
            named_range_id (str | Unset): ID of a NamedRange. Its size must be 1x1.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data_source_parameter.additional_properties = d
