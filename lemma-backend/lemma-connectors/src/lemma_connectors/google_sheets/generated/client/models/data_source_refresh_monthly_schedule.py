...
T = TypeVar("T", bound="DataSourceRefreshMonthlySchedule")
...
class DataSourceRefreshMonthlySchedule:
    """ A monthly schedule for data to refresh on specific days in the month in a given time interval.
        ...
        Attributes:
            days_of_month (list[int] | Unset): Days of the month to refresh. Only 1-28 are supported, mapping to the 1st to
    ...
    days_of_month: list[int] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data_source_refresh_monthly_schedule = cls(
            days_of_month=days_of_month,
            start_time=start_time,
        )


        data_source_refresh_monthly_schedule.additional_properties = d
        return data_source_refresh_monthly_schedule
