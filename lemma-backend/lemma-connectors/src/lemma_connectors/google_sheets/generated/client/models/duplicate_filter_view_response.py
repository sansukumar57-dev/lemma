...
T = TypeVar("T", bound="DuplicateFilterViewResponse")
...
class DuplicateFilterViewResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        duplicate_filter_view_response = cls(
            filter_=filter_,
        )


        duplicate_filter_view_response.additional_properties = d
        return duplicate_filter_view_response
