...
T = TypeVar("T", bound="BatchGetValuesResponse")
...
class BatchGetValuesResponse:
    """ The response when retrieving more than one range of values in a spreadsheet.
        ...
        Attributes:
            ...
            value_ranges (list[ValueRange] | Unset): The requested values. The order of the ValueRanges is the same as the
                order of the requested ranges.
     """

    spreadsheet_id: str | Unset = UNSET
    value_ranges: list[ValueRange] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _value_ranges is not UNSET:
            ...
            for value_ranges_item_data in _value_ranges:
                value_ranges_item = ValueRange.from_dict(value_ranges_item_data)
        ...
        batch_get_values_response = cls(
            spreadsheet_id=spreadsheet_id,
            value_ranges=value_ranges,
        )


        batch_get_values_response.additional_properties = d
        return batch_get_values_response
