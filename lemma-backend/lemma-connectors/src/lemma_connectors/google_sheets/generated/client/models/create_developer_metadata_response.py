...
T = TypeVar("T", bound="CreateDeveloperMetadataResponse")
...
class CreateDeveloperMetadataResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_developer_metadata_response = cls(
            developer_metadata=developer_metadata,
        )


        create_developer_metadata_response.additional_properties = d
        return create_developer_metadata_response
