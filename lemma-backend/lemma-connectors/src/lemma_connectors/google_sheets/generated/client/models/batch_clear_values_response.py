...
T = TypeVar("T", bound="BatchClearValuesResponse")
...
class BatchClearValuesResponse:
    """ The response when clearing a range of values in a spreadsheet.
        ...
        Attributes:
            cleared_ranges (list[str] | Unset): The ranges that were cleared, in A1 notation. If the requests are for an
                unbounded range or a ranger larger than the bounds of the sheet, this is the actual ranges that were cleared,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        batch_clear_values_response = cls(
            cleared_ranges=cleared_ranges,
            spreadsheet_id=spreadsheet_id,
        )


        batch_clear_values_response.additional_properties = d
        return batch_clear_values_response
