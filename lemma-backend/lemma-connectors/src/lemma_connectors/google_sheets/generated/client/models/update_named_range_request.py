...
T = TypeVar("T", bound="UpdateNamedRangeRequest")
...
class UpdateNamedRangeRequest:
    """ Updates properties of the named range with the specified namedRangeId.
        ...
        Attributes:
            fields (str | Unset): The fields that should be updated. At least one field must be specified. The root
                `namedRange` is implied and should not be specified. A single `"*"` can be used as short-hand for listing every
                field.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_named_range_request = cls(
            fields=fields,
            named_range=named_range,
        )


        update_named_range_request.additional_properties = d
        return update_named_range_request
