...
T = TypeVar("T", bound="BasicSeriesDataPointStyleOverride")
...
class BasicSeriesDataPointStyleOverride:
    """ Style override settings for a single series data point.
        ...
        Attributes:
            ...
            index (int | Unset): Zero based index of the series data point.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        basic_series_data_point_style_override = cls(
            color=color,
        ...
        basic_series_data_point_style_override.additional_properties = d
        return basic_series_data_point_style_override
