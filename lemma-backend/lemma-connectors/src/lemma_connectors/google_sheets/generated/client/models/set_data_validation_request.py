...
T = TypeVar("T", bound="SetDataValidationRequest")
...
class SetDataValidationRequest:
    ...
    specified.
        ...
        Attributes:
            range_ (GridRange | Unset): A range on a sheet. All indexes are zero-based. Indexes are half open, i.e. the
                ...
                `#REF!`.
            rule (DataValidationRule | Unset): A data validation rule.
     """

    range_: GridRange | Unset = UNSET
    rule: DataValidationRule | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rule: DataValidationRule | Unset
        if isinstance(_rule,  Unset):
            rule = UNSET
        else:
            rule = DataValidationRule.from_dict(_rule)




        set_data_validation_request = cls(
            range_=range_,
            rule=rule,
        )


        set_data_validation_request.additional_properties = d
