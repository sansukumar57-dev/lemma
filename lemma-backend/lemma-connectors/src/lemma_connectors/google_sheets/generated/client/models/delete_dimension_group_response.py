...
T = TypeVar("T", bound="DeleteDimensionGroupResponse")
...
class DeleteDimensionGroupResponse:
    """ The result of deleting a group.
        ...
        Attributes:
            dimension_groups (list[DimensionGroup] | Unset): All groups of a dimension after deleting a group from that
                dimension.
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_dimension_group_response = cls(
            dimension_groups=dimension_groups,
        )


        delete_dimension_group_response.additional_properties = d
        return delete_dimension_group_response
