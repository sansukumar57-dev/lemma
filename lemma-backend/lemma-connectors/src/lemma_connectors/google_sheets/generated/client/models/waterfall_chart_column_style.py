...
T = TypeVar("T", bound="WaterfallChartColumnStyle")
...
class WaterfallChartColumnStyle:
    """ Styles for a waterfall chart column.
        ...
        Attributes:
            ...
            label (str | Unset): The label of the column's legend.
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        waterfall_chart_column_style = cls(
            color=color,
        ...
        waterfall_chart_column_style.additional_properties = d
        return waterfall_chart_column_style
