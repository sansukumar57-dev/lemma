...
from ..models.color_style_theme_color import ColorStyleThemeColor
from ..types import UNSET, Unset
...
class ColorStyle:
    """ A color value.
        ...
        Attributes:
            rgb_color (Color | Unset): Represents a color in the RGBA color space. This representation is designed for
                ...
                // ...
            theme_color (ColorStyleThemeColor | Unset): Theme color.
     """

    rgb_color: Color | Unset = UNSET
    theme_color: ColorStyleThemeColor | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        theme_color: str | Unset = UNSET
        if not isinstance(self.theme_color, Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rgb_color: Color | Unset
        if isinstance(_rgb_color,  Unset):
            rgb_color = UNSET
        else:
            rgb_color = Color.from_dict(_rgb_color)




        _theme_color = d.pop("themeColor", UNSET)
        theme_color: ColorStyleThemeColor | Unset
        if isinstance(_theme_color,  Unset):
            theme_color = UNSET
        else:
            theme_color = ColorStyleThemeColor(_theme_color)
        ...
        color_style.additional_properties = d
        return color_style
