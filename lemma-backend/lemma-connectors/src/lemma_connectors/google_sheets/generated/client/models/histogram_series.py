...
T = TypeVar("T", bound="HistogramSeries")
...
class HistogramSeries:
    """ A histogram series containing the series color and data.
        ...
        Attributes:
            bar_color (Color | Unset): Represents a color in the RGBA color space. This representation is designed for
                ...
                // ...
            bar_color_style (ColorStyle | Unset): A color value.
            data (ChartData | Unset): The data included in a domain or series.
     """

    bar_color: Color | Unset = UNSET
    bar_color_style: ColorStyle | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        from ..models.color import Color
        from ..models.color_style import ColorStyle
        bar_color: dict[str, Any] | Unset = UNSET
        if not isinstance(self.bar_color, Unset):
            bar_color = self.bar_color.to_dict()

        bar_color_style: dict[str, Any] | Unset = UNSET
        if not isinstance(self.bar_color_style, Unset):
            bar_color_style = self.bar_color_style.to_dict()
        ...
        if bar_color_style is not UNSET:
            field_dict["barColorStyle"] = bar_color_style
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.color_style import ColorStyle
        d = dict(src_dict)
        _bar_color = d.pop("barColor", UNSET)
        bar_color: Color | Unset
        if isinstance(_bar_color,  Unset):
            bar_color = UNSET
        else:
            bar_color = Color.from_dict(_bar_color)




        _bar_color_style = d.pop("barColorStyle", UNSET)
        bar_color_style: ColorStyle | Unset
        if isinstance(_bar_color_style,  Unset):
            bar_color_style = UNSET
        else:
            bar_color_style = ColorStyle.from_dict(_bar_color_style)
        ...
        histogram_series = cls(
            bar_color=bar_color,
            bar_color_style=bar_color_style,
            data=data,
        )


        histogram_series.additional_properties = d
