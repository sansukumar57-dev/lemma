...
T = TypeVar("T", bound="UpdateBandingRequest")
...
class UpdateBandingRequest:
    """ Updates properties of the supplied banded range.
        ...
        Attributes:
            ...
            fields (str | Unset): The fields that should be updated. At least one field must be specified. The root
                `bandedRange` is implied and should not be specified. A single `"*"` can be used as short-hand for listing every
                field.
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_banding_request = cls(
            banded_range=banded_range,
            fields=fields,
        )


        update_banding_request.additional_properties = d
