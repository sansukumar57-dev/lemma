...
T = TypeVar("T", bound="DataSourceFormula")
...
class DataSourceFormula:
    """ A data source formula.
        ...
        Attributes:
            data_execution_status (DataExecutionStatus | Unset): The data execution status. A data execution is created to
                ...
                data source objects.
            data_source_id (str | Unset): The ID of the data source the formula is associated with.
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data_source_formula = cls(
            data_execution_status=data_execution_status,
            data_source_id=data_source_id,
        )


        data_source_formula.additional_properties = d
        return data_source_formula
