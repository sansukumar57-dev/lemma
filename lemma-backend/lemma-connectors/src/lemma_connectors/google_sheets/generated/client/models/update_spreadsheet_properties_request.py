...
T = TypeVar("T", bound="UpdateSpreadsheetPropertiesRequest")
...
class UpdateSpreadsheetPropertiesRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_spreadsheet_properties_request = cls(
            fields=fields,
            properties=properties,
        )


        update_spreadsheet_properties_request.additional_properties = d
        return update_spreadsheet_properties_request
