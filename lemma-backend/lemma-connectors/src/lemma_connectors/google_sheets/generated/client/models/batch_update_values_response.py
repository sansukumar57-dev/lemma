...
T = TypeVar("T", bound="BatchUpdateValuesResponse")
...
class BatchUpdateValuesResponse:
    """ The response when updating a range of values in a spreadsheet.
        ...
        Attributes:
            responses (list[UpdateValuesResponse] | Unset): One UpdateValuesResponse per requested range, in the same order
    ...
    responses: list[UpdateValuesResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _responses is not UNSET:
            ...
            for responses_item_data in _responses:
                responses_item = UpdateValuesResponse.from_dict(responses_item_data)
        ...
        batch_update_values_response = cls(
            responses=responses,
        ...
        batch_update_values_response.additional_properties = d
        return batch_update_values_response
