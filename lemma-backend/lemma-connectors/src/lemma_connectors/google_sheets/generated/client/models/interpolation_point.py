...
from ..models.interpolation_point_type import InterpolationPointType
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="InterpolationPoint")
...
class InterpolationPoint:
    ...
    color, type and value chosen.
        ...
        Attributes:
            ...
            type_ (InterpolationPointType | Unset): How the value should be interpreted.
            value (str | Unset): The value this interpolation point uses. May be a formula. Unused if type is MIN or MAX.
     """

    color: Color | Unset = UNSET
    color_style: ColorStyle | Unset = UNSET
    type_: InterpolationPointType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: InterpolationPointType | Unset
        if isinstance(_type_,  Unset):
            type_ = UNSET
        else:
            type_ = InterpolationPointType(_type_)
        ...
        interpolation_point.additional_properties = d
