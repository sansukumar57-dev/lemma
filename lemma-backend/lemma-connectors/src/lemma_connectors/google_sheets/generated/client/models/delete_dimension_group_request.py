...
T = TypeVar("T", bound="DeleteDimensionGroupRequest")
...
class DeleteDimensionGroupRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_dimension_group_request = cls(
            range_=range_,
        )


        delete_dimension_group_request.additional_properties = d
        return delete_dimension_group_request
