...
T = TypeVar("T", bound="UpdateDataSourceResponse")
...
class UpdateDataSourceResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_data_source_response = cls(
            data_execution_status=data_execution_status,
            data_source=data_source,
        )


        update_data_source_response.additional_properties = d
        return update_data_source_response
