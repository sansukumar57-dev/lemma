...
T = TypeVar("T", bound="FilterViewCriteria")



@_attrs_define
class FilterViewCriteria:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        filter_view_criteria.additional_properties = additional_properties
        return filter_view_criteria
