...
from ...models.sheets_spreadsheets_create_alt import SheetsSpreadsheetsCreateAlt
from ...models.sheets_spreadsheets_create_xgafv import SheetsSpreadsheetsCreateXgafv
...
def _get_kwargs(
    *,
    body: Spreadsheet | Unset = UNSET,
    xgafv: SheetsSpreadsheetsCreateXgafv | Unset = UNSET,
    access_token: str | Unset = UNSET,
    alt: SheetsSpreadsheetsCreateAlt | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        xgafv (SheetsSpreadsheetsCreateXgafv | Unset):
        access_token (str | Unset):
        alt (SheetsSpreadsheetsCreateAlt | Unset):
        callback (str | Unset):
        fields (str | Unset):
        key (str | Unset):
        ...
        body (Spreadsheet | Unset): Resource that represents a spreadsheet.
