...
T = TypeVar("T", bound="UsergroupsDisableDataBody")



@_attrs_define
class UsergroupsDisableDataBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        usergroups_disable_data_body = cls(
            usergroup=usergroup,
            include_count=include_count,
        )


        usergroups_disable_data_body.additional_properties = d
        return usergroups_disable_data_body
