...
T = TypeVar("T", bound="UsergroupsEnableJsonBody")



@_attrs_define
class UsergroupsEnableJsonBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        usergroups_enable_json_body = cls(
            usergroup=usergroup,
            include_count=include_count,
        )


        usergroups_enable_json_body.additional_properties = d
        return usergroups_enable_json_body
