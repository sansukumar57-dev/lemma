...
T = TypeVar("T", bound="FilesUploadDataBody")



@_attrs_define
class FilesUploadDataBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        files_upload_data_body.additional_properties = d
        return files_upload_data_body
