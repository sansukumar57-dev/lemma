...
T = TypeVar("T", bound="RemindersInfoRemindersInfoSchema")



@_attrs_define
class RemindersInfoRemindersInfoSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reminders_info_reminders_info_schema = cls(
            ok=ok,
            reminder=reminder,
        )

        return reminders_info_reminders_info_schema
