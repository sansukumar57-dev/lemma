...
T = TypeVar("T", bound="UsergroupsEnableDataBody")



@_attrs_define
class UsergroupsEnableDataBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        usergroups_enable_data_body = cls(
            usergroup=usergroup,
            include_count=include_count,
        )


        usergroups_enable_data_body.additional_properties = d
        return usergroups_enable_data_body
