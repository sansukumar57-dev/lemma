...
T = TypeVar("T", bound="UsergroupsDisableUsergroupsDisableSchema")



@_attrs_define
class UsergroupsDisableUsergroupsDisableSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        usergroups_disable_usergroups_disable_schema = cls(
            ok=ok,
            usergroup=usergroup,
        )

        return usergroups_disable_usergroups_disable_schema
