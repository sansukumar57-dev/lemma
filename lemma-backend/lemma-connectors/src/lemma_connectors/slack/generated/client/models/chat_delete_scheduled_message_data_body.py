...
T = TypeVar("T", bound="ChatDeleteScheduledMessageDataBody")



@_attrs_define
class ChatDeleteScheduledMessageDataBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        chat_delete_scheduled_message_data_body = cls(
            channel=channel,
            scheduled_message_id=scheduled_message_id,
            as_user=as_user,
        )
        ...
        chat_delete_scheduled_message_data_body.additional_properties = d
        return chat_delete_scheduled_message_data_body
