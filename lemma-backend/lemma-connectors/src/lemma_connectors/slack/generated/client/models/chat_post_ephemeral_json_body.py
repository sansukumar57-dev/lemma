...
T = TypeVar("T", bound="ChatPostEphemeralJsonBody")



@_attrs_define
class ChatPostEphemeralJsonBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        chat_post_ephemeral_json_body = cls(
            channel=channel,
            user=user,
            as_user=as_user,
        ...
        chat_post_ephemeral_json_body.additional_properties = d
        return chat_post_ephemeral_json_body
