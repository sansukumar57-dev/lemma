...
T = TypeVar("T", bound="UsergroupsCreateDataBody")



@_attrs_define
class UsergroupsCreateDataBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        usergroups_create_data_body = cls(
            name=name,
            channels=channels,
        ...
        usergroups_create_data_body.additional_properties = d
        return usergroups_create_data_body
