...
T = TypeVar("T", bound="UsergroupsEnableUsergroupsEnableSchema")



@_attrs_define
class UsergroupsEnableUsergroupsEnableSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        usergroups_enable_usergroups_enable_schema = cls(
            ok=ok,
            usergroup=usergroup,
        )

        return usergroups_enable_usergroups_enable_schema
