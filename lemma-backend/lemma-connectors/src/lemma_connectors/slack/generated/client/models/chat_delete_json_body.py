...
T = TypeVar("T", bound="ChatDeleteJsonBody")



@_attrs_define
class ChatDeleteJsonBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        chat_delete_json_body.additional_properties = d
        return chat_delete_json_body
