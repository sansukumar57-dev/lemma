...
T = TypeVar("T", bound="FilesRemoteAddDataBody")



@_attrs_define
class FilesRemoteAddDataBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        files_remote_add_data_body = cls(
            token=token,
        ...
        files_remote_add_data_body.additional_properties = d
        return files_remote_add_data_body
