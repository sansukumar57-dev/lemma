...
T = TypeVar("T", bound="ReactionsRemoveJsonBody")



@_attrs_define
class ReactionsRemoveJsonBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reactions_remove_json_body = cls(
            name=name,
            file=file,
        ...
        reactions_remove_json_body.additional_properties = d
        return reactions_remove_json_body
