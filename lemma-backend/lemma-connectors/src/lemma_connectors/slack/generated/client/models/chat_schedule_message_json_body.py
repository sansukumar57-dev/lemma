...
T = TypeVar("T", bound="ChatScheduleMessageJsonBody")



@_attrs_define
class ChatScheduleMessageJsonBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        chat_schedule_message_json_body = cls(
            channel=channel,
            text=text,
            post_at=post_at,
            parse=parse,
        ...
        chat_schedule_message_json_body.additional_properties = d
        return chat_schedule_message_json_body
