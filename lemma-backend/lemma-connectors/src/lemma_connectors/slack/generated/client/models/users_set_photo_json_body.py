...
T = TypeVar("T", bound="UsersSetPhotoJsonBody")



@_attrs_define
class UsersSetPhotoJsonBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        users_set_photo_json_body.additional_properties = d
        return users_set_photo_json_body
