...
T = TypeVar("T", bound="ConversationsOpenDataBody")



@_attrs_define
class ConversationsOpenDataBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conversations_open_data_body = cls(
            channel=channel,
            users=users,
            return_im=return_im,
        )
        ...
        conversations_open_data_body.additional_properties = d
        return conversations_open_data_body
