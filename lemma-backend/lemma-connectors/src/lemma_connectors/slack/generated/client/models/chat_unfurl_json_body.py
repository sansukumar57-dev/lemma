...
T = TypeVar("T", bound="ChatUnfurlJsonBody")



@_attrs_define
class ChatUnfurlJsonBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        chat_unfurl_json_body.additional_properties = d
        return chat_unfurl_json_body
