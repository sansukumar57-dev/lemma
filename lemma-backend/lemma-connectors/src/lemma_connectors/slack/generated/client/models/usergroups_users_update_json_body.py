...
T = TypeVar("T", bound="UsergroupsUsersUpdateJsonBody")



@_attrs_define
class UsergroupsUsersUpdateJsonBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        usergroups_users_update_json_body = cls(
            usergroup=usergroup,
            users=users,
        ...
        usergroups_users_update_json_body.additional_properties = d
        return usergroups_users_update_json_body
