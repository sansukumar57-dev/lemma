...
T = TypeVar("T", bound="UsergroupsCreateUsergroupsCreateSchema")



@_attrs_define
class UsergroupsCreateUsergroupsCreateSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        usergroups_create_usergroups_create_schema = cls(
            ok=ok,
            usergroup=usergroup,
        )

        return usergroups_create_usergroups_create_schema
