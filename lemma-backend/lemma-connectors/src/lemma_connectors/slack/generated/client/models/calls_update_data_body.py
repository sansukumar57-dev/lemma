...
T = TypeVar("T", bound="CallsUpdateDataBody")



@_attrs_define
class CallsUpdateDataBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        calls_update_data_body.additional_properties = d
        return calls_update_data_body
