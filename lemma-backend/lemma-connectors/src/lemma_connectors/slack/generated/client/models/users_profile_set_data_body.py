...
T = TypeVar("T", bound="UsersProfileSetDataBody")



@_attrs_define
class UsersProfileSetDataBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        users_profile_set_data_body = cls(
            name=name,
            profile=profile,
            user=user,
            value=value,
        ...
        users_profile_set_data_body.additional_properties = d
        return users_profile_set_data_body
