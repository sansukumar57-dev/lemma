...
T = TypeVar("T", bound="StarsRemoveDataBody")



@_attrs_define
class StarsRemoveDataBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        stars_remove_data_body.additional_properties = d
        return stars_remove_data_body
