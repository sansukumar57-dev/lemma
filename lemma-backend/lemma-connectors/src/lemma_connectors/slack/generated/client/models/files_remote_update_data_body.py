...
T = TypeVar("T", bound="FilesRemoteUpdateDataBody")



@_attrs_define
class FilesRemoteUpdateDataBody:
    """ 
        Attributes:
            token (str | Unset): Authentication token. Requires scope: `remote_files:write`
            file (str | Unset): Specify a file by providing its ID.
            ...
            indexable_file_contents (str | Unset): File containing contents that can be used to improve searchability for
                the remote file.
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        files_remote_update_data_body = cls(
            token=token,
            file=file,
        ...
        files_remote_update_data_body.additional_properties = d
        return files_remote_update_data_body
