...
T = TypeVar("T", bound="UsergroupsUpdateJsonBody")



@_attrs_define
class UsergroupsUpdateJsonBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        usergroups_update_json_body = cls(
            usergroup=usergroup,
            handle=handle,
        ...
        usergroups_update_json_body.additional_properties = d
        return usergroups_update_json_body
