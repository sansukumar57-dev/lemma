...
T = TypeVar("T", bound="ChatPostMessageDataBody")



@_attrs_define
class ChatPostMessageDataBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        chat_post_message_data_body = cls(
            channel=channel,
            as_user=as_user,
        ...
        chat_post_message_data_body.additional_properties = d
        return chat_post_message_data_body
