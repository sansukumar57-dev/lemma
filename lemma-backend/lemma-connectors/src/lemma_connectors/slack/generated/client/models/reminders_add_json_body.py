...
T = TypeVar("T", bound="RemindersAddJsonBody")



@_attrs_define
class RemindersAddJsonBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reminders_add_json_body.additional_properties = d
        return reminders_add_json_body
