...
T = TypeVar("T", bound="ChatUpdateJsonBody")



@_attrs_define
class ChatUpdateJsonBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        chat_update_json_body.additional_properties = d
        return chat_update_json_body
