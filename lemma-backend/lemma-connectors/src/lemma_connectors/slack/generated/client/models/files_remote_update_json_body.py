...
T = TypeVar("T", bound="FilesRemoteUpdateJsonBody")



@_attrs_define
class FilesRemoteUpdateJsonBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        files_remote_update_json_body = cls(
            token=token,
            file=file,
        ...
        files_remote_update_json_body.additional_properties = d
        return files_remote_update_json_body
