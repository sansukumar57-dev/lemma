...
from ...models.calendar_events_patch_alt import CalendarEventsPatchAlt
from ...models.calendar_events_patch_send_updates import CalendarEventsPatchSendUpdates
...
def _get_kwargs(
    ...
    *,
    ...
    send_updates: CalendarEventsPatchSendUpdates | Unset = UNSET,
    supports_attachments: bool | Unset = UNSET,
    alt: CalendarEventsPatchAlt | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        send_updates (CalendarEventsPatchSendUpdates | Unset):
        supports_attachments (bool | Unset):
        alt (CalendarEventsPatchAlt | Unset):
        fields (str | Unset):
        key (str | Unset):
