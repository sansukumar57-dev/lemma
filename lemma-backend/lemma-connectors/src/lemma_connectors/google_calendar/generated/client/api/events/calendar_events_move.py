...
from ...models.calendar_events_move_alt import CalendarEventsMoveAlt
from ...models.calendar_events_move_send_updates import CalendarEventsMoveSendUpdates
...
def _get_kwargs(
    ...
    *,
    ...
    send_updates: CalendarEventsMoveSendUpdates | Unset = UNSET,
    alt: CalendarEventsMoveAlt | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/calendars/{calendar_id}/events/{event_id}/move".format(calendar_id=quote(str(calendar_id), safe=""),event_id=quote(str(event_id), safe=""),),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        send_updates (CalendarEventsMoveSendUpdates | Unset):
        alt (CalendarEventsMoveAlt | Unset):
        fields (str | Unset):
        key (str | Unset):
