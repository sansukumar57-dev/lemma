...
from ...models.calendar_events_update_alt import CalendarEventsUpdateAlt
from ...models.calendar_events_update_send_updates import CalendarEventsUpdateSendUpdates
...
def _get_kwargs(
    ...
    *,
    ...
    send_updates: CalendarEventsUpdateSendUpdates | Unset = UNSET,
    supports_attachments: bool | Unset = UNSET,
    alt: CalendarEventsUpdateAlt | Unset = UNSET,
    ...
    json_send_updates: str | Unset = UNSET
    if not isinstance(send_updates, Unset):
        json_send_updates = send_updates.value

    params["sendUpdates"] = json_send_updates
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/calendars/{calendar_id}/events/{event_id}".format(calendar_id=quote(str(calendar_id), safe=""),event_id=quote(str(event_id), safe=""),),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        send_updates (CalendarEventsUpdateSendUpdates | Unset):
        supports_attachments (bool | Unset):
        alt (CalendarEventsUpdateAlt | Unset):
        fields (str | Unset):
        key (str | Unset):
