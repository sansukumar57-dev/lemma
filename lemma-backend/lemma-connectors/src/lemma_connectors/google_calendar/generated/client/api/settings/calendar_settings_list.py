...
from ...models.calendar_settings_list_alt import CalendarSettingsListAlt
...
def _get_kwargs(
    *,
    ...
    alt: CalendarSettingsListAlt | Unset = UNSET,
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Settings | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[Settings]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        alt (CalendarSettingsListAlt | Unset):
        fields (str | Unset):
        key (str | Unset):
