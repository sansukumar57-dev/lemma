...
from ...models.calendar_calendar_list_delete_alt import CalendarCalendarListDeleteAlt
...
def _get_kwargs(
    calendar_id: str,
    *,
    alt: CalendarCalendarListDeleteAlt | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        calendar_id (str):
        alt (CalendarCalendarListDeleteAlt | Unset):
        fields (str | Unset):
        key (str | Unset):
