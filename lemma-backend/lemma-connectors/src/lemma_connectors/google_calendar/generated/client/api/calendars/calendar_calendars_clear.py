...
from ...models.calendar_calendars_clear_alt import CalendarCalendarsClearAlt
...
def _get_kwargs(
    calendar_id: str,
    *,
    alt: CalendarCalendarsClearAlt | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/calendars/{calendar_id}/clear".format(calendar_id=quote(str(calendar_id), safe=""),),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        calendar_id (str):
        alt (CalendarCalendarsClearAlt | Unset):
        fields (str | Unset):
        key (str | Unset):
