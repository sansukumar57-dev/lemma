...
from ...models.calendar_events_get_alt import CalendarEventsGetAlt
...
def _get_kwargs(
    ...
    *,
    ...
    alt: CalendarEventsGetAlt | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    """  Returns an event based on its Google Calendar ID. To retrieve an event using its iCalendar ID, call
    the events.list method using the iCalUID parameter.
    ...
    Args:
        ...
        time_zone (str | Unset):
        alt (CalendarEventsGetAlt | Unset):
        fields (str | Unset):
        key (str | Unset):
