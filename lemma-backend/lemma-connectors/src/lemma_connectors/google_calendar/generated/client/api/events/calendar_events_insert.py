...
from ...models.calendar_events_insert_alt import CalendarEventsInsertAlt
from ...models.calendar_events_insert_send_updates import CalendarEventsInsertSendUpdates
...
def _get_kwargs(
    ...
    *,
    ...
    send_updates: CalendarEventsInsertSendUpdates | Unset = UNSET,
    supports_attachments: bool | Unset = UNSET,
    alt: CalendarEventsInsertAlt | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        send_updates (CalendarEventsInsertSendUpdates | Unset):
        supports_attachments (bool | Unset):
        alt (CalendarEventsInsertAlt | Unset):
        fields (str | Unset):
        key (str | Unset):
