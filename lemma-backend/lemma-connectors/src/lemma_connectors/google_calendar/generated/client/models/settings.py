...
class Settings:
    """ 
        Attributes:
            ...
            items (list[Setting] | Unset): List of user settings.
            kind (str | Unset): Type of the collection ("calendar#settings"). Default: 'calendar#settings'.
    ...
    items: list[Setting] | Unset = UNSET
    kind: str | Unset = 'calendar#settings'
