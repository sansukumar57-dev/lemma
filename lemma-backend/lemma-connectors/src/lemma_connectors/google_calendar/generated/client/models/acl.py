...
class Acl:
    """ 
        Attributes:
            ...
            items (list[AclRule] | Unset): List of rules on the access control list.
            kind (str | Unset): Type of the collection ("calendar#acl"). Default: 'calendar#acl'.
    ...
    items: list[AclRule] | Unset = UNSET
    kind: str | Unset = 'calendar#acl'
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _items is not UNSET:
            ...
            for items_item_data in _items:
                items_item = AclRule.from_dict(items_item_data)
