...
from ...models.function_run_list_response import FunctionRunListResponse
...
) -> ErrorResponse | FunctionRunListResponse | None:
    if response.status_code == 200:
        response_200 = FunctionRunListResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | FunctionRunListResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | FunctionRunListResponse
    """
