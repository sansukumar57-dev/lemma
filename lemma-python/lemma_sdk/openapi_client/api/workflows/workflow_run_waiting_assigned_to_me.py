...
from ...models.workflow_run_wait_assignment_list_response import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/pods/{pod_id}/workflow-runs/waiting/assigned-to-me".format(
...
) -> ErrorResponse | WorkflowRunWaitAssignmentListResponse | None:
    if response.status_code == 200:
        response_200 = WorkflowRunWaitAssignmentListResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | WorkflowRunWaitAssignmentListResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | WorkflowRunWaitAssignmentListResponse
    """
