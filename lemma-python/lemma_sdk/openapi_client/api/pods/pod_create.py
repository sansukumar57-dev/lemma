...
from ...models.pod_create_request import PodCreateRequest
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = PodResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        body (PodCreateRequest): Pod creation request schema.
