...
from ...models.bulk_delete_records_request import BulkDeleteRecordsRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/pods/{pod_id}/datastore/tables/{table_name}/records/bulk/delete".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (BulkDeleteRecordsRequest): Schema for bulk deleting records.
