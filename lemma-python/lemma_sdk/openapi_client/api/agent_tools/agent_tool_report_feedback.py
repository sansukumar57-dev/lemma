...
from ...models.report_feedback_request import ReportFeedbackRequest
from ...models.report_feedback_response import ReportFeedbackResponse
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = ReportFeedbackResponse.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | ReportFeedbackResponse
    """
