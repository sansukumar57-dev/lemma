...
if TYPE_CHECKING:
    from ..models.function_run_summary_response import FunctionRunSummaryResponse


T = TypeVar("T", bound="FunctionRunListResponse")


@_attrs_define
class FunctionRunListResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = FunctionRunSummaryResponse.from_dict(items_item_data)
        ...
        function_run_list_response = cls(
            items=items,
            limit=limit,
            next_page_token=next_page_token,
        )

        function_run_list_response.additional_properties = d
        return function_run_list_response
