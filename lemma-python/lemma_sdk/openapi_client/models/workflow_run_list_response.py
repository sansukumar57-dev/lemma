...
T = TypeVar("T", bound="WorkflowRunListResponse")
...
class WorkflowRunListResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = WorkflowRunSummaryResponse.from_dict(items_item_data)
        ...
        workflow_run_list_response = cls(
            items=items,
            limit=limit,
            next_page_token=next_page_token,
        )

        workflow_run_list_response.additional_properties = d
        return workflow_run_list_response
