...
T = TypeVar("T", bound="AccountListResponseSchema")


@_attrs_define
class AccountListResponseSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = AccountResponseSchema.from_dict(items_item_data)
        ...
        account_list_response_schema = cls(
            items=items,
            limit=limit,
            next_page_token=next_page_token,
        )

        account_list_response_schema.additional_properties = d
        return account_list_response_schema
