...
T = TypeVar("T", bound="ManualWorkflowStartInput")


@_attrs_define
class ManualWorkflowStartInput:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        manual_workflow_start_input = cls(
            config=config,
            type_=type_,
        )

        manual_workflow_start_input.additional_properties = d
        return manual_workflow_start_input
