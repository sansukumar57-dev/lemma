...
if TYPE_CHECKING:
    ...
    from ..models.wait_until_node_response_position_type_0 import (
        WaitUntilNodeResponsePositionType0,
    )


T = TypeVar("T", bound="WaitUntilNodeResponse")


@_attrs_define
class WaitUntilNodeResponse:
    """
    Attributes:
        config (WaitUntilNodeConfig):
        id (str):
        label (None | str | Unset):
        position (None | Unset | WaitUntilNodeResponsePositionType0):
    ...
    position: None | Unset | WaitUntilNodeResponsePositionType0 = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.position, Unset):
            position = UNSET
        elif isinstance(self.position, WaitUntilNodeResponsePositionType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_position(
            data: object,
        ) -> None | Unset | WaitUntilNodeResponsePositionType0:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        wait_until_node_response.additional_properties = d
        return wait_until_node_response
