...
if TYPE_CHECKING:
    from ..models.event_flow_start_output_trigger_config import (
        EventFlowStartOutputTriggerConfig,
    )


T = TypeVar("T", bound="EventFlowStartOutput")


@_attrs_define
class EventFlowStartOutput:
    """
    Attributes:
        connector_id (str): Connector connector identifier.
        connector_trigger_id (str): Connector trigger identifier to subscribe to.
        trigger_config (EventFlowStartOutputTriggerConfig | Unset):
    """

    connector_id: str
    connector_trigger_id: str
    trigger_config: EventFlowStartOutputTriggerConfig | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_trigger_config, Unset):
            ...
            trigger_config = EventFlowStartOutputTriggerConfig.from_dict(
                _trigger_config
            )

        event_flow_start_output = cls(
            connector_id=connector_id,
            connector_trigger_id=connector_trigger_id,
            trigger_config=trigger_config,
        )

        event_flow_start_output.additional_properties = d
        return event_flow_start_output
