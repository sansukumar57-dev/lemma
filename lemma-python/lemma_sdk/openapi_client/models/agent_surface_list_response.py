...
T = TypeVar("T", bound="AgentSurfaceListResponse")


@_attrs_define
class AgentSurfaceListResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = AgentSurfaceResponse.from_dict(items_item_data)
        ...
        agent_surface_list_response = cls(
            items=items,
            limit=limit,
            next_page_token=next_page_token,
        )

        agent_surface_list_response.additional_properties = d
        return agent_surface_list_response
