...
T = TypeVar("T", bound="ConnectorListResponseSchema")


@_attrs_define
class ConnectorListResponseSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = ConnectorResponseSchema.from_dict(items_item_data)
        ...
        connector_list_response_schema = cls(
            items=items,
            limit=limit,
            next_page_token=next_page_token,
        )

        connector_list_response_schema.additional_properties = d
        return connector_list_response_schema
