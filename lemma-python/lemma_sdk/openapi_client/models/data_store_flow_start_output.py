...
T = TypeVar("T", bound="DataStoreFlowStartOutput")


@_attrs_define
class DataStoreFlowStartOutput:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data_store_flow_start_output = cls(
            table_name=table_name,
            operations=operations,
        )

        data_store_flow_start_output.additional_properties = d
        return data_store_flow_start_output
