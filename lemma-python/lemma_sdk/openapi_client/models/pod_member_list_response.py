...
T = TypeVar("T", bound="PodMemberListResponse")


@_attrs_define
class PodMemberListResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = PodMemberResponse.from_dict(items_item_data)
        ...
        pod_member_list_response.additional_properties = d
        return pod_member_list_response
