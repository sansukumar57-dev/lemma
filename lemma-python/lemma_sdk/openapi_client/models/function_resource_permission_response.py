...
T = TypeVar("T", bound="FunctionResourcePermissionResponse")


@_attrs_define
class FunctionResourcePermissionResponse:
    """
    Attributes:
        resource_name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        function_resource_permission_response = cls(
            resource_name=resource_name,
            resource_type=resource_type,
            permission_ids=permission_ids,
        )

        function_resource_permission_response.additional_properties = d
        return function_resource_permission_response
