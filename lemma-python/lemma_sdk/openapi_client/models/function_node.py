...
if TYPE_CHECKING:
    ...
    from ..models.function_node_position_type_0 import FunctionNodePositionType0


T = TypeVar("T", bound="FunctionNode")
...
class FunctionNode:
    ...
    the function run for asynchronous ones.
        ...
        Attributes:
            ...
            position (FunctionNodePositionType0 | None | Unset):
    ...
    position: FunctionNodePositionType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.position, Unset):
            position = UNSET
        elif isinstance(self.position, FunctionNodePositionType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_position(data: object) -> FunctionNodePositionType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                position_type_0 = FunctionNodePositionType0.from_dict(data)

                return position_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(FunctionNodePositionType0 | None | Unset, data)
        ...
        function_node.additional_properties = d
