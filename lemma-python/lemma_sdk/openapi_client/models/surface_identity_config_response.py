...
T = TypeVar("T", bound="SurfaceIdentityConfigResponse")


@_attrs_define
class SurfaceIdentityConfigResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        surface_identity_config_response = cls(
            allowed_domains=allowed_domains,
            allowed_email_addresses=allowed_email_addresses,
        )

        surface_identity_config_response.additional_properties = d
        return surface_identity_config_response
