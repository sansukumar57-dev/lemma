...
if TYPE_CHECKING:
    from ..models.app_trigger_summary_response_schema import (
        AppTriggerSummaryResponseSchema,
    )


T = TypeVar("T", bound="AppTriggerListResponseSchema")


@_attrs_define
class AppTriggerListResponseSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = AppTriggerSummaryResponseSchema.from_dict(items_item_data)
        ...
        app_trigger_list_response_schema = cls(
            items=items,
            limit=limit,
            next_page_token=next_page_token,
        )

        app_trigger_list_response_schema.additional_properties = d
        return app_trigger_list_response_schema
