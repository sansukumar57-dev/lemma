...
if TYPE_CHECKING:
    ...
    from ..models.end_node_response_position_type_0 import EndNodeResponsePositionType0


T = TypeVar("T", bound="EndNodeResponse")
...
class EndNodeResponse:
    ...
    Attributes:
        ...
        position (EndNodeResponsePositionType0 | None | Unset):
    ...
    position: EndNodeResponsePositionType0 | None | Unset = UNSET
    type_: Literal["END"] | Unset = "END"
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.end_node_response_position_type_0 import (
        ...
        if isinstance(self.position, Unset):
            position = UNSET
        elif isinstance(self.position, EndNodeResponsePositionType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_position(
            data: object,
        ) -> EndNodeResponsePositionType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        end_node_response.additional_properties = d
        return end_node_response
