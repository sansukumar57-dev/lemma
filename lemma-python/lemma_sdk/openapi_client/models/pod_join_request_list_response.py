...
T = TypeVar("T", bound="PodJoinRequestListResponse")


@_attrs_define
class PodJoinRequestListResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.pod_join_request_create_response import (
        ...
        for items_item_data in _items:
            items_item = PodJoinRequestCreateResponse.from_dict(items_item_data)
        ...
        pod_join_request_list_response = cls(
            items=items,
            limit=limit,
            total=total,
        ...
        pod_join_request_list_response.additional_properties = d
        return pod_join_request_list_response
