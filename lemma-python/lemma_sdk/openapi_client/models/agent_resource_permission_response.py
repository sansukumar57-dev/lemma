...
T = TypeVar("T", bound="AgentResourcePermissionResponse")


@_attrs_define
class AgentResourcePermissionResponse:
    """
    Attributes:
        resource_name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        agent_resource_permission_response = cls(
            resource_name=resource_name,
            resource_type=resource_type,
            permission_ids=permission_ids,
        )

        agent_resource_permission_response.additional_properties = d
        return agent_resource_permission_response
