...
T = TypeVar("T", bound="FunctionNodeConfigInputMapping")


@_attrs_define
class FunctionNodeConfigInputMapping:
    """Explicit mapping from function argument key to either an expression or a literal JSON value. Strings are never auto-
    interpreted.

        Example:
            {'amount': {'type': 'expression', 'value': 'collect_input.amount'}, 'currency': {'type': 'literal', 'value':
                'USD'}}
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        function_node_config_input_mapping = cls()
        ...
        function_node_config_input_mapping.additional_properties = additional_properties
        return function_node_config_input_mapping
