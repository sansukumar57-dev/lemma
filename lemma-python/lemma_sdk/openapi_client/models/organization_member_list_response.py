...
T = TypeVar("T", bound="OrganizationMemberListResponse")
...
class OrganizationMemberListResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        organization_member_list_response = cls(
            items=items,
            limit=limit,
            next_page_token=next_page_token,
        )

        organization_member_list_response.additional_properties = d
        return organization_member_list_response
