...
class OrganizationInvitationListResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.organization_invitation_response import (
        ...
        for items_item_data in _items:
            items_item = OrganizationInvitationResponse.from_dict(items_item_data)
        ...
        organization_invitation_list_response.additional_properties = d
