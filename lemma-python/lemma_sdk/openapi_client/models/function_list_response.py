...
if TYPE_CHECKING:
    from ..models.function_summary_response import FunctionSummaryResponse


T = TypeVar("T", bound="FunctionListResponse")
...
class FunctionListResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = FunctionSummaryResponse.from_dict(items_item_data)
        ...
        function_list_response = cls(
            items=items,
            limit=limit,
            next_page_token=next_page_token,
        )

        function_list_response.additional_properties = d
        return function_list_response
