...
T = TypeVar("T", bound="PodRoleResourcePermissionResponse")


@_attrs_define
class PodRoleResourcePermissionResponse:
    """
    Attributes:
        resource_name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pod_role_resource_permission_response = cls(
            resource_name=resource_name,
            resource_type=resource_type,
            permission_ids=permission_ids,
        )

        pod_role_resource_permission_response.additional_properties = d
        return pod_role_resource_permission_response
